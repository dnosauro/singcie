...
import okhttp3.internal.p171ws.RealWebSocket;
...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:34:0x013b A[Catch:{ all -> 0x0131 }] */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x0141 A[Catch:{ all -> 0x0131 }] */
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) {
        /*
            ...
            r2 = 0
            java.net.Socket r3 = r7.rawSocket     // Catch:{ AssertionError -> 0x0134 }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0134 }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0134 }
            okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x0134 }
            int r5 = r5.port()     // Catch:{ AssertionError -> 0x0134 }
            r6 = 1
            java.net.Socket r1 = r1.createSocket(r3, r4, r5, r6)     // Catch:{ AssertionError -> 0x0134 }
            javax.net.ssl.SSLSocket r1 = (javax.net.ssl.SSLSocket) r1     // Catch:{ AssertionError -> 0x0134 }
            okhttp3.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            if (r3 == 0) goto L_0x0041
            okhttp3.internal.platform.Platform r3 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.util.List r5 = r0.protocols()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r3.configureTlsExtensions(r1, r4, r5)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
        L_0x0041:
            r1.startHandshake()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            javax.net.ssl.SSLSession r3 = r1.getSession()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okhttp3.Handshake r4 = okhttp3.Handshake.get(r3)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okhttp3.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r6 = r6.host()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            boolean r3 = r5.verify(r6, r3)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            if (r3 != 0) goto L_0x00da
            java.util.List r8 = r4.peerCertificates()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            boolean r2 = r8.isEmpty()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            if (r2 != 0) goto L_0x00b6
            r2 = 0
            java.lang.Object r8 = r8.get(r2)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.security.cert.X509Certificate r8 = (java.security.cert.X509Certificate) r8     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            javax.net.ssl.SSLPeerUnverifiedException r2 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r3.<init>()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r4 = "Hostname "
            r3.append(r4)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r3.append(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = " not verified:\n    certificate: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = okhttp3.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r3.append(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = "\n    DN: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.security.Principal r0 = r8.getSubjectDN()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = r0.getName()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r3.append(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = "\n    subjectAltNames: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.util.List r8 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r3.append(r8)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r8 = r3.toString()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r2.<init>(r8)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            throw r2     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
        L_0x00b6:
            javax.net.ssl.SSLPeerUnverifiedException r8 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r2.<init>()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r3 = "Hostname "
            r2.append(r3)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r2.append(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = " not verified (no certificates)"
            r2.append(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = r2.toString()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r8.<init>(r0)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            throw r8     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
        L_0x00da:
            okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.util.List r5 = r4.peerCertificates()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r3.check((java.lang.String) r0, (java.util.List<java.security.cert.Certificate>) r5)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            boolean r8 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            if (r8 == 0) goto L_0x00fb
            okhttp3.internal.platform.Platform r8 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.lang.String r2 = r8.getSelectedProtocol(r1)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
        L_0x00fb:
            r7.socket = r1     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okio.Source r8 = okio.Okio.source((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okio.BufferedSource r8 = okio.Okio.buffer((okio.Source) r8)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r7.source = r8     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okio.Sink r8 = okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            okio.BufferedSink r8 = okio.Okio.buffer((okio.Sink) r8)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r7.sink = r8     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            r7.handshake = r4     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            if (r2 == 0) goto L_0x011e
            okhttp3.Protocol r8 = okhttp3.Protocol.get(r2)     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
            goto L_0x0120
        L_0x011e:
            okhttp3.Protocol r8 = okhttp3.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
        L_0x0120:
            r7.protocol = r8     // Catch:{ AssertionError -> 0x012e, all -> 0x012c }
        ...
        L_0x0134:
            r8 = move-exception
        L_0x0135:
            boolean r0 = okhttp3.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x0131 }
            if (r0 == 0) goto L_0x0141
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x0131 }
            r0.<init>(r8)     // Catch:{ all -> 0x0131 }
    ...
    private Request createTunnelRequest() {
        Request build = new Request.Builder().url(this.route.address().url()).method("CONNECT", (RequestBody) null).header("Host", Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header(AbstractSpiCall.HEADER_USER_AGENT, Version.userAgent()).build();
