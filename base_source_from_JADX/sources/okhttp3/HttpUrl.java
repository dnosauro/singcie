    ...
    public static final class Builder {
        ...
        public Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                        ...
                        switch (charAt) {
                            ...
                            case '@':
                                if (!z) {
                                    ...
                                    if (i3 != i) {
                                        this.encodedPassword = HttpUrl.canonicalize(str, i3 + 1, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                        z = true;
                                    }
                                    z2 = true;
                                } else {
                ...
                int portColonOffset = portColonOffset(str2, i2, i4);
                int i5 = portColonOffset + 1;
                if (i5 < i4) {
                    this.host = canonicalizeHost(str2, i2, portColonOffset);
                    this.port = parsePort(str2, i5, i4);
                    if (this.port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str2.substring(i5, i4) + '\"');
                    }
                } else {
                    this.host = canonicalizeHost(str2, i2, portColonOffset);
                ...
                if (this.host != null) {
                    skipLeadingAsciiWhitespace = i4;
                } else {
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i2, portColonOffset) + '\"');
                }
            } else {
