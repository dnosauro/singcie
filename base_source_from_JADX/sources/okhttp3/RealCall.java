    ...
    final class AsyncCall extends NamedRunnable {
        ...
        public void execute() {
            /*
                ...
                r0.enter()
                r0 = 0
                okhttp3.RealCall r1 = okhttp3.RealCall.this     // Catch:{ IOException -> 0x0050, Throwable -> 0x0028 }
                okhttp3.Response r0 = r1.getResponseWithInterceptorChain()     // Catch:{ IOException -> 0x0050, Throwable -> 0x0028 }
                r1 = 1
                okhttp3.Callback r2 = r5.responseCallback     // Catch:{ IOException -> 0x0024, Throwable -> 0x0022 }
                okhttp3.RealCall r3 = okhttp3.RealCall.this     // Catch:{ IOException -> 0x0024, Throwable -> 0x0022 }
            ...
            L_0x0028:
                ...
                r1 = 0
            L_0x002b:
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0026 }
                ...
                okhttp3.Callback r2 = r5.responseCallback     // Catch:{ all -> 0x0026 }
                okhttp3.RealCall r3 = okhttp3.RealCall.this     // Catch:{ all -> 0x0026 }
            ...
            L_0x0053:
                ...
                okhttp3.internal.platform.Platform r1 = okhttp3.internal.platform.Platform.get()     // Catch:{ all -> 0x0026 }
                r2 = 4
                ...
                okhttp3.RealCall r4 = okhttp3.RealCall.this     // Catch:{ all -> 0x0026 }
                ...
                goto L_0x0016
            L_0x007b:
                okhttp3.RealCall r1 = okhttp3.RealCall.this     // Catch:{ all -> 0x0026 }
                okhttp3.EventListener r1 = r1.eventListener     // Catch:{ all -> 0x0026 }
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0026 }
                r1.callFailed(r2, r0)     // Catch:{ all -> 0x0026 }
                okhttp3.Callback r1 = r5.responseCallback     // Catch:{ all -> 0x0026 }
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0026 }
