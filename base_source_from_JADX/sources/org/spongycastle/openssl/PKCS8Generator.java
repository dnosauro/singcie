...
public class PKCS8Generator implements PemObjectGenerator {
    ...
    private PemObject generate(PrivateKeyInfo privateKeyInfo, OutputEncryptor outputEncryptor2) {
        try {
    ...
    public PemObject generate() {
        ...
        return outputEncryptor2 != null ? generate(this.key, outputEncryptor2) : generate(this.key, (OutputEncryptor) null);
    }
}
