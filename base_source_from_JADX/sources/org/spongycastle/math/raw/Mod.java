        ...
        if (Nat.isZero(length, iArr2)) {
            ...
            while (true) {
                ...
                if (copy[i3] == 0 && copy2[i3] == 0) {
                    ...
                    inversionStep = inversionStep(iArr, copy, i, create, inversionStep + (Nat.subFrom(length, create2, create) - i2));
                    if (Nat.isOne(i, copy)) {
                        inversionResult(iArr, inversionStep, create, iArr3);
                        return;
                    }
                    ...
                    i2 = inversionStep(iArr, copy2, i, create2, i2 + (Nat.subFrom(length, create, create2) - inversionStep));
