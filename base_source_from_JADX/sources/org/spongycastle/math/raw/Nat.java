...
public abstract class Nat {
    ...
    /* renamed from: M */
    private static final long f8090M = 4294967295L;
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            int i7 = i4 + i6;
            long j2 = j + (((long) iArr[i2 + i6]) & 4294967295L) + (((long) iArr2[i3 + i6]) & 4294967295L) + (4294967295L & ((long) iArr3[i7]));
            iArr3[i7] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    /* renamed from: eq */
    public static boolean m9226eq(int i, int[] iArr, int[] iArr2) {
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i7 = 0; i7 < i5; i7++) {
            int i8 = i6 + i5;
            long mulWordAddTo = (((long) mulWordAddTo(i, iArr[i2 + i7], iArr2, i3, iArr3, i6)) & 4294967295L) + j + (4294967295L & ((long) iArr3[i8]));
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        ...
        do {
            int i7 = i4 + i6;
            long j3 = j2 + ((((long) iArr[i + i5]) & 4294967295L) * j) + (((long) iArr2[i7]) & 4294967295L);
            iArr2[i7] = (int) j3;
            j2 = j3 >>> 32;
            i6++;
            i5++;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            int i7 = i4 + i6;
            long j2 = j + (((((long) iArr3[i7]) & 4294967295L) - (((long) iArr[i2 + i6]) & 4294967295L)) - (4294967295L & ((long) iArr2[i3 + i6])));
            iArr3[i7] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
