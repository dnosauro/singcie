...
public class SecT113R2Point extends ECPoint.AbstractF2m {
    ...
    SecT113R2Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement6.isZero()) {
                return new SecT113R2Point(curve, eCFieldElement6, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT113R2Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    }

    /* access modifiers changed from: protected */
    public ECPoint detach() {
        return new SecT113R2Point((ECCurve) null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public ECPoint negate() {
        ...
        return new SecT113R2Point(eCCurve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), eCFieldElementArr, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        if (add.isZero()) {
            return new SecT113R2Point(curve, add, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT113R2Point(curve, square2, eCFieldElement.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }
