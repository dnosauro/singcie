...
public class SecT113R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint detach() {
        return new SecT113R1Point((ECCurve) null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public ECPoint negate() {
        ...
        return new SecT113R1Point(eCCurve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), eCFieldElementArr, this.withCompression);
    }
