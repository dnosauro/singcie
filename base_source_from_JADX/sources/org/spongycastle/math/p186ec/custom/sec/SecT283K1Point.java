...
public class SecT283K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElement6 = divide.square().add(divide).add(xCoord);
            if (eCFieldElement6.isZero()) {
                return new SecT283K1Point(curve, eCFieldElement6, curve.getB(), this.withCompression);
            }
        ...
        return new SecT283K1Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    }

    /* access modifiers changed from: protected */
    public ECPoint detach() {
        return new SecT283K1Point((ECCurve) null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public ECPoint negate() {
        ...
        return new SecT283K1Point(eCCurve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), eCFieldElementArr, this.withCompression);
    }
