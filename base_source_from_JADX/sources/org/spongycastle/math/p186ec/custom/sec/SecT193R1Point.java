...
public class SecT193R1Point extends ECPoint.AbstractF2m {
    ...
    SecT193R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement6.isZero()) {
                return new SecT193R1Point(curve, eCFieldElement6, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT193R1Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    }

    /* access modifiers changed from: protected */
    public ECPoint detach() {
        return new SecT193R1Point((ECCurve) null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public ECPoint negate() {
        ...
        return new SecT193R1Point(eCCurve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), eCFieldElementArr, this.withCompression);
    }
