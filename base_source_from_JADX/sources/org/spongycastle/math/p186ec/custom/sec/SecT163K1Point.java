...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint detach() {
        return new SecT163K1Point((ECCurve) null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT163K1Point(curve, square, square2.add(add).add(eCFieldElement3).multiply(square2).add(square), new ECFieldElement[]{multiply2}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        return new SecT163K1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, rawYCoord.addOne(), multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
    }
}
