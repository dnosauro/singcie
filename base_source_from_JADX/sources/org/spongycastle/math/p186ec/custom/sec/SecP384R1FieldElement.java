...
public class SecP384R1FieldElement extends ECFieldElement {
    ...
    /* renamed from: Q */
    public static final BigInteger f8070Q = SecP384R1Curve.f8067q;

    /* renamed from: x */
    protected int[] f8071x;

    public SecP384R1FieldElement() {
        this.f8071x = Nat.create(12);
    }

    public SecP384R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f8070Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP384R1FieldElement");
        }
        this.f8071x = SecP384R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP384R1Field.add(this.f8071x, ((SecP384R1FieldElement) eCFieldElement).f8071x, create);
        return new SecP384R1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat.create(12);
        SecP384R1Field.addOne(this.f8071x, create);
        return new SecP384R1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        Mod.invert(SecP384R1Field.f8069P, ((SecP384R1FieldElement) eCFieldElement).f8071x, create);
        SecP384R1Field.multiply(create, this.f8071x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat.m9226eq(12, this.f8071x, ((SecP384R1FieldElement) obj).f8071x);
    }
    ...
    public int getFieldSize() {
        return f8070Q.bitLength();
    }

    public int hashCode() {
        return f8070Q.hashCode() ^ Arrays.hashCode(this.f8071x, 0, 12);
    }

    public ECFieldElement invert() {
        int[] create = Nat.create(12);
        Mod.invert(SecP384R1Field.f8069P, this.f8071x, create);
        return new SecP384R1FieldElement(create);
    }

    public boolean isOne() {
        return Nat.isOne(12, this.f8071x);
    }

    public boolean isZero() {
        return Nat.isZero(12, this.f8071x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.multiply(this.f8071x, ((SecP384R1FieldElement) eCFieldElement).f8071x, create);
        return new SecP384R1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat.create(12);
        SecP384R1Field.negate(this.f8071x, create);
        return new SecP384R1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f8071x;
        ...
        if (Nat.m9226eq(12, iArr, create2)) {
            return new SecP384R1FieldElement(create);
        }
        return null;
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat.create(12);
        SecP384R1Field.square(this.f8071x, create);
        return new SecP384R1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.subtract(this.f8071x, ((SecP384R1FieldElement) eCFieldElement).f8071x, create);
        return new SecP384R1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat.getBit(this.f8071x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat.toBigInteger(12, this.f8071x);
    }
}
