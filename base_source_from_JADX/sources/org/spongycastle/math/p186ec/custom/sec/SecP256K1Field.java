...
public class SecP256K1Field {
    ...
    /* renamed from: P */
    static final int[] f8057P = {-977, -2, -1, -1, -1, -1, -1, -1};

    /* renamed from: P7 */
    private static final int f8058P7 = -1;
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f8057P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f8057P))) {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[7] == -1 && Nat256.gte(fromBigInteger, f8057P)) {
            Nat256.subFrom(f8057P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, iArr2, Nat256.add(iArr, f8057P, iArr2));
        }
    }
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat256.isZero(iArr)) {
            ...
            Nat256.sub(f8057P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat256.mul33DWordAdd(PInv33, Nat256.mul33Add(PInv33, iArr, 8, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f8057P))) {
            Nat.add33To(8, PInv33, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i != 0 && Nat256.mul33WordAdd(PInv33, i, iArr, 0) != 0) || (iArr[7] == -1 && Nat256.gte(iArr, f8057P))) {
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f8057P))) {
            Nat.add33To(8, PInv33, iArr2);
        }
    }
}
