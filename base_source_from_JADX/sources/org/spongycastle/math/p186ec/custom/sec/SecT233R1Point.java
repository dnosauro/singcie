...
public class SecT233R1Point extends ECPoint.AbstractF2m {
    ...
    SecT233R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement6.isZero()) {
                return new SecT233R1Point(curve, eCFieldElement6, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT233R1Point(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
    }
    ...
    public ECPoint negate() {
        ...
        return new SecT233R1Point(eCCurve, eCFieldElement, eCFieldElement2.add(eCFieldElement3), eCFieldElementArr, this.withCompression);
    }
