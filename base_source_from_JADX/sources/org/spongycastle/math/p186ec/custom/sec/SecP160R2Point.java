...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R2FieldElement secP160R2FieldElement = (SecP160R2FieldElement) this.f8001x;
        SecP160R2FieldElement secP160R2FieldElement2 = (SecP160R2FieldElement) this.f8002y;
        ...
        SecP160R2FieldElement secP160R2FieldElement5 = (SecP160R2FieldElement) this.f8003zs[0];
        ...
        if (isOne) {
            iArr2 = secP160R2FieldElement3.f8033x;
            iArr = secP160R2FieldElement4.f8033x;
        } else {
            SecP160R2Field.square(secP160R2FieldElement5.f8033x, create2);
            SecP160R2Field.multiply(create2, secP160R2FieldElement3.f8033x, create);
            SecP160R2Field.multiply(create2, secP160R2FieldElement5.f8033x, create2);
            SecP160R2Field.multiply(create2, secP160R2FieldElement4.f8033x, create2);
            iArr2 = create;
            iArr = create2;
        }
        boolean isOne2 = secP160R2FieldElement6.isOne();
        if (isOne2) {
            iArr4 = secP160R2FieldElement.f8033x;
            iArr3 = secP160R2FieldElement2.f8033x;
        } else {
            SecP160R2Field.square(secP160R2FieldElement6.f8033x, create3);
            SecP160R2Field.multiply(create3, secP160R2FieldElement.f8033x, createExt);
            SecP160R2Field.multiply(create3, secP160R2FieldElement6.f8033x, create3);
            SecP160R2Field.multiply(create3, secP160R2FieldElement2.f8033x, create3);
            iArr4 = createExt;
            iArr3 = create3;
        }
        ...
        SecP160R2Field.square(create, secP160R2FieldElement7.f8033x);
        SecP160R2Field.subtract(secP160R2FieldElement7.f8033x, create5, secP160R2FieldElement7.f8033x);
        SecP160R2FieldElement secP160R2FieldElement8 = new SecP160R2FieldElement(create5);
        SecP160R2Field.subtract(create2, secP160R2FieldElement7.f8033x, secP160R2FieldElement8.f8033x);
        SecP160R2Field.multiplyAddToExt(secP160R2FieldElement8.f8033x, create, createExt);
        SecP160R2Field.reduce(createExt, secP160R2FieldElement8.f8033x);
        SecP160R2FieldElement secP160R2FieldElement9 = new SecP160R2FieldElement(create4);
        if (!isOne) {
            SecP160R2Field.multiply(secP160R2FieldElement9.f8033x, secP160R2FieldElement5.f8033x, secP160R2FieldElement9.f8033x);
        }
        if (!isOne2) {
            SecP160R2Field.multiply(secP160R2FieldElement9.f8033x, secP160R2FieldElement6.f8033x, secP160R2FieldElement9.f8033x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R2Point(this.curve, this.f8001x, this.f8002y.negate(), this.f8003zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R2FieldElement secP160R2FieldElement = (SecP160R2FieldElement) this.f8002y;
        if (secP160R2FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R2FieldElement secP160R2FieldElement2 = (SecP160R2FieldElement) this.f8001x;
        SecP160R2FieldElement secP160R2FieldElement3 = (SecP160R2FieldElement) this.f8003zs[0];
        int[] create = Nat160.create();
        int[] create2 = Nat160.create();
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f8033x, create3);
        int[] create4 = Nat160.create();
        SecP160R2Field.square(create3, create4);
        boolean isOne = secP160R2FieldElement3.isOne();
        int[] iArr = secP160R2FieldElement3.f8033x;
        if (!isOne) {
            SecP160R2Field.square(secP160R2FieldElement3.f8033x, create2);
            iArr = create2;
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.f8033x, iArr, create);
        SecP160R2Field.add(secP160R2FieldElement2.f8033x, iArr, create2);
        ...
        SecP160R2Field.square(create2, secP160R2FieldElement4.f8033x);
        SecP160R2Field.subtract(secP160R2FieldElement4.f8033x, create3, secP160R2FieldElement4.f8033x);
        SecP160R2Field.subtract(secP160R2FieldElement4.f8033x, create3, secP160R2FieldElement4.f8033x);
        SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(create3);
        SecP160R2Field.subtract(create3, secP160R2FieldElement4.f8033x, secP160R2FieldElement5.f8033x);
        SecP160R2Field.multiply(secP160R2FieldElement5.f8033x, create2, secP160R2FieldElement5.f8033x);
        SecP160R2Field.subtract(secP160R2FieldElement5.f8033x, create, secP160R2FieldElement5.f8033x);
        SecP160R2FieldElement secP160R2FieldElement6 = new SecP160R2FieldElement(create2);
        SecP160R2Field.twice(secP160R2FieldElement.f8033x, secP160R2FieldElement6.f8033x);
        if (!isOne) {
            SecP160R2Field.multiply(secP160R2FieldElement6.f8033x, secP160R2FieldElement3.f8033x, secP160R2FieldElement6.f8033x);
        }
