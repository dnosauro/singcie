...
public class SecP224K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f8001x;
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f8002y;
        ...
        SecP224K1FieldElement secP224K1FieldElement5 = (SecP224K1FieldElement) this.f8003zs[0];
        ...
        if (isOne) {
            iArr2 = secP224K1FieldElement3.f8049x;
            iArr = secP224K1FieldElement4.f8049x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement5.f8049x, create2);
            SecP224K1Field.multiply(create2, secP224K1FieldElement3.f8049x, create);
            SecP224K1Field.multiply(create2, secP224K1FieldElement5.f8049x, create2);
            SecP224K1Field.multiply(create2, secP224K1FieldElement4.f8049x, create2);
            iArr2 = create;
            iArr = create2;
        }
        boolean isOne2 = secP224K1FieldElement6.isOne();
        if (isOne2) {
            iArr4 = secP224K1FieldElement.f8049x;
            iArr3 = secP224K1FieldElement2.f8049x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement6.f8049x, create3);
            SecP224K1Field.multiply(create3, secP224K1FieldElement.f8049x, createExt);
            SecP224K1Field.multiply(create3, secP224K1FieldElement6.f8049x, create3);
            SecP224K1Field.multiply(create3, secP224K1FieldElement2.f8049x, create3);
            iArr4 = createExt;
            iArr3 = create3;
        }
        ...
        SecP224K1Field.square(create, secP224K1FieldElement7.f8049x);
        SecP224K1Field.subtract(secP224K1FieldElement7.f8049x, create5, secP224K1FieldElement7.f8049x);
        SecP224K1FieldElement secP224K1FieldElement8 = new SecP224K1FieldElement(create5);
        SecP224K1Field.subtract(create2, secP224K1FieldElement7.f8049x, secP224K1FieldElement8.f8049x);
        SecP224K1Field.multiplyAddToExt(secP224K1FieldElement8.f8049x, create, createExt);
        SecP224K1Field.reduce(createExt, secP224K1FieldElement8.f8049x);
        SecP224K1FieldElement secP224K1FieldElement9 = new SecP224K1FieldElement(create4);
        if (!isOne) {
            SecP224K1Field.multiply(secP224K1FieldElement9.f8049x, secP224K1FieldElement5.f8049x, secP224K1FieldElement9.f8049x);
        }
        if (!isOne2) {
            SecP224K1Field.multiply(secP224K1FieldElement9.f8049x, secP224K1FieldElement6.f8049x, secP224K1FieldElement9.f8049x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224K1Point(this.curve, this.f8001x, this.f8002y.negate(), this.f8003zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f8002y;
        if (secP224K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f8001x;
        SecP224K1FieldElement secP224K1FieldElement3 = (SecP224K1FieldElement) this.f8003zs[0];
        int[] create = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement.f8049x, create);
        int[] create2 = Nat224.create();
        SecP224K1Field.square(create, create2);
        int[] create3 = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement2.f8049x, create3);
        SecP224K1Field.reduce32(Nat224.addBothTo(create3, create3, create3), create3);
        SecP224K1Field.multiply(create, secP224K1FieldElement2.f8049x, create);
        ...
        SecP224K1Field.square(create3, secP224K1FieldElement4.f8049x);
        SecP224K1Field.subtract(secP224K1FieldElement4.f8049x, create, secP224K1FieldElement4.f8049x);
        SecP224K1Field.subtract(secP224K1FieldElement4.f8049x, create, secP224K1FieldElement4.f8049x);
        SecP224K1FieldElement secP224K1FieldElement5 = new SecP224K1FieldElement(create);
        SecP224K1Field.subtract(create, secP224K1FieldElement4.f8049x, secP224K1FieldElement5.f8049x);
        SecP224K1Field.multiply(secP224K1FieldElement5.f8049x, create3, secP224K1FieldElement5.f8049x);
        SecP224K1Field.subtract(secP224K1FieldElement5.f8049x, create4, secP224K1FieldElement5.f8049x);
        SecP224K1FieldElement secP224K1FieldElement6 = new SecP224K1FieldElement(create3);
        SecP224K1Field.twice(secP224K1FieldElement.f8049x, secP224K1FieldElement6.f8049x);
        if (!secP224K1FieldElement3.isOne()) {
            SecP224K1Field.multiply(secP224K1FieldElement6.f8049x, secP224K1FieldElement3.f8049x, secP224K1FieldElement6.f8049x);
        }
