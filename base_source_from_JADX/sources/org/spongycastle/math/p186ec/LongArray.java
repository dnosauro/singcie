...
class LongArray implements Cloneable {
    ...
    private static int bitLength(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p186ec.LongArray.bitLength(long):int");
    }
    ...
    private static long interleave2_32to64(int i) {
        ...
        return (((long) s) & BodyPartID.bodyIdMax) | ((((long) ((sArr[i >>> 24] << 16) | s2)) & BodyPartID.bodyIdMax) << 32);
    }
    ...
    private static long interleave3_13to65(int i) {
        ...
        return (((long) iArr[i & CertificateBody.profileType]) & BodyPartID.bodyIdMax) | ((((long) iArr[i >>> 7]) & BodyPartID.bodyIdMax) << 35);
    }

    private static long interleave3_21to63(int i) {
        int[] iArr = INTERLEAVE3_TABLE;
        int i2 = iArr[i & CertificateBody.profileType];
        int i3 = iArr[(i >>> 7) & CertificateBody.profileType];
        return (((long) i2) & BodyPartID.bodyIdMax) | ((((long) iArr[i >>> 14]) & BodyPartID.bodyIdMax) << 42) | ((((long) i3) & BodyPartID.bodyIdMax) << 21);
    }

    private static long interleave4_16to64(int i) {
        int[] iArr = INTERLEAVE4_TABLE;
        return (((long) iArr[i & 255]) & BodyPartID.bodyIdMax) | ((((long) iArr[i >>> 8]) & BodyPartID.bodyIdMax) << 32);
    }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i10 = 56; i10 >= 0; i10 -= 8) {
            for (int i11 = 1; i11 < i4; i11 += 2) {
                int i12 = (int) (jArr6[i11] >>> i10);
                addBoth(jArr7, i11 - 1, jArr4, iArr3[i12 & 15], jArr5, iArr3[(i12 >>> 4) & 15], i7);
            }
        ...
        for (int i13 = 56; i13 >= 0; i13 -= 8) {
            for (int i14 = 0; i14 < i4; i14 += 2) {
                ...
                addBoth(jArr7, i14, jArr4, iArr3[i15 & 15], jArr5, iArr3[(i15 >>> 4) & 15], i7);
            }
            if (i13 > 0) {
                shiftUp(jArr7, 0, i6, 8);
            }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i3 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i4, jArr2, 0);
        ...
        iArr2[1] = i6;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i6, i4);
        int i7 = 2;
        int i8 = i6;
        while (i7 < 16) {
            i8 += i6;
