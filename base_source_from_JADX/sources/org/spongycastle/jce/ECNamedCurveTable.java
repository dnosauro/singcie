...
public class ECNamedCurveTable {
    public static Enumeration getNames() {
        return org.spongycastle.asn1.p176x9.ECNamedCurveTable.getNames();
    }
    ...
    public static ECNamedCurveParameterSpec getParameterSpec(String str) {
        ...
        if (byName == null) {
            ...
            if (byName == null && (byName = org.spongycastle.asn1.p176x9.ECNamedCurveTable.getByName(str)) == null) {
                try {
                    byName = org.spongycastle.asn1.p176x9.ECNamedCurveTable.getByOID(new ASN1ObjectIdentifier(str));
