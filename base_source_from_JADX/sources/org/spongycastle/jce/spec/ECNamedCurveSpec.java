...
public class ECNamedCurveSpec extends ECParameterSpec {
    ...
    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.spongycastle.math.p186ec.ECPoint eCPoint, BigInteger bigInteger) {
        super(convertCurve(eCCurve, (byte[]) null), convertPoint(eCPoint), bigInteger, 1);
        this.name = str;
    }

    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.spongycastle.math.p186ec.ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2) {
        super(convertCurve(eCCurve, (byte[]) null), convertPoint(eCPoint), bigInteger, bigInteger2.intValue());
        this.name = str;
    }

    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.spongycastle.math.p186ec.ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
    ...
    private static ECPoint convertPoint(org.spongycastle.math.p186ec.ECPoint eCPoint) {
        org.spongycastle.math.p186ec.ECPoint normalize = eCPoint.normalize();
