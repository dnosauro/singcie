...
class RFC3280CertPathUtilities {
    ...
    protected static void checkCRLs(org.spongycastle.jcajce.PKIXExtendedParameters r20, java.security.cert.X509Certificate r21, java.util.Date r22, java.security.cert.X509Certificate r23, java.security.PublicKey r24, java.util.List r25, org.spongycastle.jcajce.util.JcaJceHelper r26) {
        ...
        L_0x002f:
            ...
            org.spongycastle.asn1.x509.DistributionPoint[] r7 = r0.getDistributionPoints()     // Catch:{ Exception -> 0x0092 }
        ...
        L_0x004f:
            ...
            r1 = r7[r6]     // Catch:{ AnnotatedException -> 0x007d }
            r2 = r15
            r3 = r21
            r4 = r22
            r5 = r23
            ...
            r9 = r25
            r10 = r26
            checkCRL(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10)     // Catch:{ AnnotatedException -> 0x007b }
            r17 = 1
            goto L_0x0084
        L_0x007b:
            r0 = move-exception
        ...
        L_0x00a1:
            ...
            org.spongycastle.asn1.ASN1InputStream r1 = new org.spongycastle.asn1.ASN1InputStream     // Catch:{ Exception -> 0x00f4 }
            org.spongycastle.asn1.x500.X500Name r2 = org.spongycastle.jce.provider.PrincipalUtils.getEncodedIssuerPrincipal(r21)     // Catch:{ Exception -> 0x00f4 }
            byte[] r2 = r2.getEncoded()     // Catch:{ Exception -> 0x00f4 }
            r1.<init>((byte[]) r2)     // Catch:{ Exception -> 0x00f4 }
            org.spongycastle.asn1.ASN1Primitive r1 = r1.readObject()     // Catch:{ Exception -> 0x00f4 }
            org.spongycastle.asn1.x509.DistributionPoint r2 = new org.spongycastle.asn1.x509.DistributionPoint     // Catch:{ AnnotatedException -> 0x00f2 }
            org.spongycastle.asn1.x509.DistributionPointName r3 = new org.spongycastle.asn1.x509.DistributionPointName     // Catch:{ AnnotatedException -> 0x00f2 }
            org.spongycastle.asn1.x509.GeneralNames r4 = new org.spongycastle.asn1.x509.GeneralNames     // Catch:{ AnnotatedException -> 0x00f2 }
            org.spongycastle.asn1.x509.GeneralName r5 = new org.spongycastle.asn1.x509.GeneralName     // Catch:{ AnnotatedException -> 0x00f2 }
            r6 = 4
            r5.<init>((int) r6, (org.spongycastle.asn1.ASN1Encodable) r1)     // Catch:{ AnnotatedException -> 0x00f2 }
            r4.<init>((org.spongycastle.asn1.x509.GeneralName) r5)     // Catch:{ AnnotatedException -> 0x00f2 }
            r1 = 0
            r3.<init>(r1, r4)     // Catch:{ AnnotatedException -> 0x00f2 }
            r1 = 0
            r2.<init>(r3, r1, r1)     // Catch:{ AnnotatedException -> 0x00f2 }
            java.lang.Object r1 = r20.clone()     // Catch:{ AnnotatedException -> 0x00f2 }
            r3 = r1
            org.spongycastle.jcajce.PKIXExtendedParameters r3 = (org.spongycastle.jcajce.PKIXExtendedParameters) r3     // Catch:{ AnnotatedException -> 0x00f2 }
            r1 = r2
            r2 = r3
            r3 = r21
            r4 = r22
            ...
            r9 = r25
            r10 = r26
            checkCRL(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10)     // Catch:{ AnnotatedException -> 0x00f2 }
            r17 = 1
            goto L_0x00fd
        L_0x00f2:
            r0 = move-exception
        ...
        L_0x00f4:
            r0 = move-exception
            org.spongycastle.jce.provider.AnnotatedException r1 = new org.spongycastle.jce.provider.AnnotatedException     // Catch:{ AnnotatedException -> 0x00f2 }
            java.lang.String r2 = "Issuer from certificate for CRL could not be reencoded."
            r1.<init>(r2, r0)     // Catch:{ AnnotatedException -> 0x00f2 }
            throw r1     // Catch:{ AnnotatedException -> 0x00f2 }
        L_0x00fd:
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    protected static int prepareNextCertJ(java.security.cert.CertPath r2, int r3, int r4) {
        /*
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    protected static int prepareNextCertM(java.security.cert.CertPath r2, int r3, int r4) {
        /*
            java.util.List r0 = r2.getCertificates()
            java.lang.Object r0 = r0.get(r3)
            java.security.cert.X509Certificate r0 = (java.security.cert.X509Certificate) r0
    ...
    protected static void processCertA(CertPath certPath, PKIXExtendedParameters pKIXExtendedParameters, int i, PublicKey publicKey, boolean z, X500Name x500Name, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) {
        ...
        try {
            ...
            if (!PrincipalUtils.getEncodedIssuerPrincipal(x509Certificate2).equals(x500Name)) {
                throw new ExtCertPathValidatorException("IssuerName(" + PrincipalUtils.getEncodedIssuerPrincipal(x509Certificate2) + ") does not match SubjectName(" + x500Name + ") of signing certificate.", (Throwable) null, certPath, i);
            }
