    ...
    public CertPathValidatorResult engineValidate(CertPath certPath, CertPathParameters certPathParameters) {
        ...
        if (z || (certPathParameters instanceof PKIXExtendedParameters)) {
            ...
            if (targetConstraints instanceof X509AttributeCertStoreSelector) {
                ...
                try {
                    RFC3281CertPathUtilities.checkCRLs(attributeCert, pKIXExtendedParameters2, x509Certificate, CertPathValidatorUtilities.getValidCertDateFromValidityModel(pKIXExtendedParameters2, (CertPath) null, -1), certPath.getCertificates(), this.helper);
