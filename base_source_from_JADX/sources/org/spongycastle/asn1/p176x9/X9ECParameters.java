...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    /* renamed from: g */
    private X9ECPoint f7433g;

    /* renamed from: h */
    private BigInteger f7434h;

    /* renamed from: n */
    private BigInteger f7435n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        if (objectAt instanceof X9ECPoint) {
            this.f7433g = (X9ECPoint) objectAt;
        } else {
            this.f7433g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
        this.f7435n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        this.seed = x9Curve.getSeed();
        if (aSN1Sequence.size() == 6) {
            this.f7434h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
    }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f7433g = x9ECPoint;
        this.f7435n = bigInteger;
        this.f7434h = bigInteger2;
        this.seed = bArr;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f7433g);
        aSN1EncodableVector.add(new ASN1Integer(this.f7435n));
        BigInteger bigInteger = this.f7434h;
        if (bigInteger != null) {
