...
public class X962NamedCurves {
    static X9ECParametersHolder c2pnb163v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("0307AF69989546103D79329FCC3D74880F33BBE803CB")), bigInteger, valueOf, Hex.decode("D2C0FB15760860DEF1EEF4D696E6768756151754"));
        }
    };
    static X9ECParametersHolder c2pnb163v2 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("030024266E4EB5106D0A964D92C4860E2671DB9B6CC5")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2pnb163v3 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("0202F9F87B7C574D0BDECF8A22E6524775F98CDEBDCB")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2pnb176w1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("038D16C2866798B600F9F08BB4A8E860F3298CE04A5798")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2pnb208w1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m((int) ParseException.ACCOUNT_ALREADY_LINKED, 1, 2, 83, new BigInteger("0", 16), new BigInteger("00C8619ED45A62E6212E1160349E2BFA844439FAFC2A3FD1638F9E", 16), bigInteger, valueOf);
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("0289FDFBE4ABE193DF9559ECF07AC0CE78554E2784EB8C1ED1A57A")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2pnb272w1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("026108BABB2CEEBCF787058A056CBE0CFE622D7723A289E08A07AE13EF0D10D171DD8D")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2pnb304w1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("02197B07845E9BE2D96ADB0F5F3C7F2CFFBD7A3EB8B6FEC35C7FD67F26DDF6285A644F740A2614")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2pnb368w1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("021085E2755381DCCCE3C1557AFA10C2F0C0C2825646C5B34A394CBCFA8BC16B22E7E789E927BE216F02E1FB136A5F")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2tnb191v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("0236B3DAF8A23206F9C4F299D7B21A9C369137F2C84AE1AA0D")), bigInteger, valueOf, Hex.decode("4E13CA542744D696E67687561517552F279A8C84"));
        }
    };
    static X9ECParametersHolder c2tnb191v2 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("023809B2B7CC1B28CC5A87926AAD83FD28789E81E2C9E3BF10")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2tnb191v3 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("03375D4CE24FDE434489DE8746E71786015009E66E38A926DD")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2tnb239v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("0257927098FA932E7C0A96D3FD5B706EF7E5F5C156E16B7E7C86038552E91D")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2tnb239v2 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("0228F9D04E900069C8DC47A08534FE76D2B900B7D7EF31F5709F200C4CA205")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2tnb239v3 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("0370F6E9D04D289C4E89913CE3530BFDE903977D42B146D539BF1BDE4E9C92")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2tnb359v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("033C258EF3047767E7EDE0F1FDAA79DAEE3841366A132E163ACED4ED2401DF9C6BDCDE98E8E707C07A2239B1B097")), bigInteger, valueOf, (byte[]) null);
        }
    };
    static X9ECParametersHolder c2tnb431r1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.decode("02120FC05D3C67A99DE161D2F4092622FECA701BE4F50F4758714E8A87BBF2A658EF8C21E7C5EFE965361F6C2999C0C247B0DBD70CE6B7")), bigInteger, valueOf, (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder prime192v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            ECCurve.C3628Fp fp = new ECCurve.C3628Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("64210519e59c80e70fa7e9ab72243049feb8deecc146b9b1", 16), bigInteger, valueOf);
            return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.decode("03188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012")), bigInteger, valueOf, Hex.decode("3045AE6FC8422f64ED579528D38120EAE12196D5"));
        }
    };
    static X9ECParametersHolder prime192v2 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1);
            ECCurve.C3628Fp fp = new ECCurve.C3628Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("cc22d6dfb95c6b25e49c0d6364a4e5980c393aa21668d953", 16), bigInteger, valueOf);
            return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.decode("03eea2bae7e1497842f2de7769cfe9c989c072ad696f48034a")), bigInteger, valueOf, Hex.decode("31a92ee2029fd10d901b113e990710f0d21ac6b6"));
        }
    };
    static X9ECParametersHolder prime192v3 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1);
            ECCurve.C3628Fp fp = new ECCurve.C3628Fp(new BigInteger("6277101735386680763835789423207666416083908700390324961279"), new BigInteger("fffffffffffffffffffffffffffffffefffffffffffffffc", 16), new BigInteger("22123dc2395a05caa7423daeccc94760a7d462256bd56916", 16), bigInteger, valueOf);
            return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.decode("027d29778100c65a1da1783716588dce2b8b4aee8e228f1896")), bigInteger, valueOf, Hex.decode("c469684435deb378c4b65ca9591e2a5763059a2e"));
        }
    };
    static X9ECParametersHolder prime239v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1);
            ECCurve.C3628Fp fp = new ECCurve.C3628Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("6b016c3bdcf18941d0d654921475ca71a9db2fb27d1d37796185c2942c0a", 16), bigInteger, valueOf);
            return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.decode("020ffa963cdca8816ccc33b8642bedf905c3d358573d3f27fbbd3b3cb9aaaf")), bigInteger, valueOf, Hex.decode("e43bb460f0b80cc0c0b075798e948060f8321b7d"));
        }
    };
    static X9ECParametersHolder prime239v2 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1);
            ECCurve.C3628Fp fp = new ECCurve.C3628Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("617fab6832576cbbfed50d99f0249c3fee58b94ba0038c7ae84c8c832f2c", 16), bigInteger, valueOf);
            return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.decode("0238af09d98727705120c921bb5e9e26296a3cdcf2f35757a0eafd87b830e7")), bigInteger, valueOf, Hex.decode("e8b4011604095303ca3b8099982be09fcb9ae616"));
        }
    };
    static X9ECParametersHolder prime239v3 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1);
            ECCurve.C3628Fp fp = new ECCurve.C3628Fp(new BigInteger("883423532389192164791648750360308885314476597252960362792450860609699839"), new BigInteger("7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc", 16), new BigInteger("255705fa2a306654b1f4cb03d6a750a30c250102d4988717d9ba15ab6d3e", 16), bigInteger, valueOf);
            return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.decode("036768ae8e18bb92cfcf005c949aa2c6d94853d0e660bbf854b1c9505fe95a")), bigInteger, valueOf, Hex.decode("7d7374168ffe3471b60a857686a19475d3bfa2ff"));
        }
    };
    static X9ECParametersHolder prime256v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1);
            ECCurve.C3628Fp fp = new ECCurve.C3628Fp(new BigInteger("115792089210356248762697446949407573530086143415290314195533631308867097853951"), new BigInteger("ffffffff00000001000000000000000000000000fffffffffffffffffffffffc", 16), new BigInteger("5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", 16), bigInteger, valueOf);
            return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.decode("036b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296")), bigInteger, valueOf, Hex.decode("c49d360886e704936a6678e1139d26b7819f7e90"));
        }
    };
