...
public class X509Extensions extends ASN1Object {
    ...
    public X509Extensions(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (instance.size() == 3) {
                this.extensions.put(instance.getObjectAt(0), new X509Extension(ASN1Boolean.getInstance((Object) instance.getObjectAt(1)), ASN1OctetString.getInstance(instance.getObjectAt(2))));
