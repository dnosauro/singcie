...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(minMaxIPs[0], minMaxIPs[2]), min(minMaxIPs[1], minMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m9130or(minMaxIPs[0], minMaxIPs[2]), m9130or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m9130or(byte[] bArr, byte[] bArr2) {
    ...
    private void unionEmail(java.lang.String r4, java.lang.String r5, java.util.Set r6) {
        ...
        L_0x00b1:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.asn1.x509.PKIXNameConstraintValidator.unionEmail(java.lang.String, java.lang.String, java.util.Set):void");
    }
    ...
    private void unionURI(java.lang.String r4, java.lang.String r5, java.util.Set r6) {
        ...
        L_0x00b1:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.asn1.x509.PKIXNameConstraintValidator.unionURI(java.lang.String, java.lang.String, java.util.Set):void");
    }
