...
public class AttributeCertificateHolder implements CertSelector, Selector {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0090, code lost:
        if (org.spongycastle.util.Arrays.areEqual(r0.digest(), getObjectDigest()) != false) goto L_0x0092;
     */
    ...
    public boolean match(java.security.cert.Certificate r5) {
        ...
        L_0x0006:
            ...
            org.spongycastle.asn1.x509.Holder r2 = r4.holder     // Catch:{  }
            org.spongycastle.asn1.x509.IssuerSerial r2 = r2.getBaseCertificateID()     // Catch:{  }
            r3 = 1
            if (r2 == 0) goto L_0x0040
            org.spongycastle.asn1.x509.Holder r5 = r4.holder     // Catch:{  }
            org.spongycastle.asn1.x509.IssuerSerial r5 = r5.getBaseCertificateID()     // Catch:{  }
            org.spongycastle.asn1.ASN1Integer r5 = r5.getSerial()     // Catch:{  }
            ...
            org.spongycastle.jce.X509Principal r5 = org.spongycastle.jce.PrincipalUtil.getIssuerX509Principal((java.security.cert.X509Certificate) r0)     // Catch:{  }
            org.spongycastle.asn1.x509.Holder r0 = r4.holder     // Catch:{  }
            org.spongycastle.asn1.x509.IssuerSerial r0 = r0.getBaseCertificateID()     // Catch:{  }
            org.spongycastle.asn1.x509.GeneralNames r0 = r0.getIssuer()     // Catch:{  }
        ...
        L_0x0040:
            org.spongycastle.asn1.x509.Holder r2 = r4.holder     // Catch:{  }
            org.spongycastle.asn1.x509.GeneralNames r2 = r2.getEntityName()     // Catch:{  }
            if (r2 == 0) goto L_0x0059
            org.spongycastle.jce.X509Principal r0 = org.spongycastle.jce.PrincipalUtil.getSubjectX509Principal(r0)     // Catch:{  }
            org.spongycastle.asn1.x509.Holder r2 = r4.holder     // Catch:{  }
            org.spongycastle.asn1.x509.GeneralNames r2 = r2.getEntityName()     // Catch:{  }
        ...
        L_0x0059:
            org.spongycastle.asn1.x509.Holder r0 = r4.holder     // Catch:{  }
            org.spongycastle.asn1.x509.ObjectDigestInfo r0 = r0.getObjectDigestInfo()     // Catch:{  }
        ...
        L_0x0084:
            ...
            boolean r5 = org.spongycastle.util.Arrays.areEqual((byte[]) r5, (byte[]) r0)     // Catch:{  }
