...
import org.spongycastle.operator.p189bc.BcDigestProvider;
...
class EnvelopedDataHelper {
    ...
    static BufferedBlockCipher createCipher(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
    ...
    static Object createContentCipher(boolean z, CipherParameters cipherParameters, AlgorithmIdentifier algorithmIdentifier) {
    ...
    static Wrapper createRFC3211Wrapper(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        if (NISTObjectIdentifiers.id_aes128_CBC.equals(aSN1ObjectIdentifier) || NISTObjectIdentifiers.id_aes192_CBC.equals(aSN1ObjectIdentifier) || NISTObjectIdentifiers.id_aes256_CBC.equals(aSN1ObjectIdentifier)) {
    ...
    /* access modifiers changed from: package-private */
    public AlgorithmIdentifier generateAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, CipherParameters cipherParameters, SecureRandom secureRandom) {
