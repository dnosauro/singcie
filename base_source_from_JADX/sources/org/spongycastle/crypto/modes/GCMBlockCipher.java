...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    private void initCipher() {
        ...
        if (this.atLengthPre > 0) {
            System.arraycopy(this.S_atPre, 0, this.f7801S, 0, 16);
        }
    }
    ...
    private void reset(boolean z) {
        ...
        this.atLength = 0;
        this.atLengthPre = 0;
        this.counter = Arrays.clone(this.f7800J0);
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        if (this.atLength > this.atLengthPre) {
            ...
            if (this.exp == null) {
                ...
                this.exp.init(this.f7799H);
            }
            this.exp.exponentiateX(j2, bArr2);
            GCMUtil.multiply(this.S_at, bArr2);
            GCMUtil.xor(this.f7801S, this.S_at);
        }
        byte[] bArr3 = new byte[16];
        Pack.longToBigEndian(this.atLength * 8, bArr3, 0);
        Pack.longToBigEndian(this.totalLength * 8, bArr3, 8);
        gHASHBlock(this.f7801S, bArr3);
        byte[] bArr4 = new byte[16];
        this.cipher.processBlock(this.f7800J0, 0, bArr4, 0);
        GCMUtil.xor(bArr4, this.f7801S);
        int i5 = this.macSize;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (keyParameter != null) {
            ...
            this.f7799H = new byte[16];
            BlockCipher blockCipher = this.cipher;
            byte[] bArr4 = this.f7799H;
            blockCipher.processBlock(bArr4, 0, bArr4, 0);
            this.multiplier.init(this.f7799H);
            this.exp = null;
        } else if (this.f7799H == null) {
            throw new IllegalArgumentException("Key must be specified in initial init");
        }
        this.f7800J0 = new byte[16];
        byte[] bArr5 = this.nonce;
        if (bArr5.length == 12) {
            System.arraycopy(bArr5, 0, this.f7800J0, 0, bArr5.length);
            this.f7800J0[15] = 1;
        } else {
            gHASH(this.f7800J0, bArr5, bArr5.length);
            byte[] bArr6 = new byte[16];
            Pack.longToBigEndian(((long) this.nonce.length) * 8, bArr6, 8);
            gHASHBlock(this.f7800J0, bArr6);
        }
        this.f7801S = new byte[16];
        this.S_at = new byte[16];
        this.S_atPre = new byte[16];
