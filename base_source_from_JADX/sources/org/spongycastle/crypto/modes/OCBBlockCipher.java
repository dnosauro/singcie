...
public class OCBBlockCipher implements AEADBlockCipher {
    ...
    public byte[] getLSub(int i) {
        while (i >= this.f7813L.size()) {
            Vector vector = this.f7813L;
            vector.addElement(OCB_double((byte[]) vector.lastElement()));
        }
        return (byte[]) this.f7813L.elementAt(i);
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (bArr.length <= 15) {
            ...
            this.f7813L = new Vector();
            this.f7813L.addElement(OCB_double(this.L_Dollar));
