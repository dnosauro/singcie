...
public class Blake2bDigest implements ExtendedDigest {
    ...
    /* renamed from: t0 */
    private long f7494t0;

    /* renamed from: t1 */
    private long f7495t1;
    ...
    public Blake2bDigest(Blake2bDigest blake2bDigest) {
        ...
        this.f7494t0 = blake2bDigest.f7494t0;
        this.f7495t1 = blake2bDigest.f7495t1;
        this.f7493f0 = blake2bDigest.f7493f0;
    }
    ...
    /* renamed from: G */
    private void m9136G(long j, long j2, int i, int i2, int i3, int i4) {
    ...
    private void compress(byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < rOUNDS; i4++) {
            ...
            m9136G(jArr[bArr2[i4][0]], jArr[bArr2[i4][1]], 0, 4, 8, 12);
            byte[][] bArr3 = blake2b_sigma;
            m9136G(jArr[bArr3[i4][2]], jArr[bArr3[i4][3]], 1, 5, 9, 13);
            byte[][] bArr4 = blake2b_sigma;
            m9136G(jArr[bArr4[i4][4]], jArr[bArr4[i4][5]], 2, 6, 10, 14);
            byte[][] bArr5 = blake2b_sigma;
            m9136G(jArr[bArr5[i4][6]], jArr[bArr5[i4][7]], 3, 7, 11, 15);
            byte[][] bArr6 = blake2b_sigma;
            m9136G(jArr[bArr6[i4][8]], jArr[bArr6[i4][9]], 0, 5, 10, 15);
            byte[][] bArr7 = blake2b_sigma;
            m9136G(jArr[bArr7[i4][10]], jArr[bArr7[i4][11]], 1, 6, 11, 12);
            byte[][] bArr8 = blake2b_sigma;
            m9136G(jArr[bArr8[i4][12]], jArr[bArr8[i4][13]], 2, 7, 8, 13);
            byte[][] bArr9 = blake2b_sigma;
            m9136G(jArr[bArr9[i4][14]], jArr[bArr9[i4][15]], 3, 4, 9, 14);
        }
        while (true) {
    ...
    private void init() {
        if (this.chainValue == null) {
            ...
            if (bArr2 != null) {
                ...
                jArr6[7] = jArr6[7] ^ bytes2long(this.personalization, 8);
            }
        }
    }
    ...
    private void initializeInternalState() {
        ...
        jArr2[12] = j ^ jArr3[4];
        jArr2[13] = this.f7495t1 ^ jArr3[5];
        jArr2[14] = this.f7493f0 ^ jArr3[6];
        jArr2[15] = jArr3[7];
    }
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        this.f7494t0 = j + ((long) i3);
        long j2 = this.f7494t0;
        if (j2 < 0 && ((long) i3) > (-j2)) {
            this.f7495t1++;
        }
    ...
    public void update(byte[] r12, int r13, int r14) {
        ...
        L_0x0029:
            ...
            r11.bufferPos = r7
            byte[] r0 = r11.buffer
            org.spongycastle.util.Arrays.fill((byte[]) r0, (byte) r7)
            goto L_0x0042
        L_0x0036:
            byte[] r1 = r11.buffer
        ...
        L_0x0065:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.crypto.digests.Blake2bDigest.update(byte[], int, int):void");
    }
}
