...
public class DSTU7564Digest implements ExtendedDigest, Memoable {
    ...
    public DSTU7564Digest(int i) {
        ...
        if (i == 256 || i == 384 || i == 512) {
            ...
            while (true) {
                ...
                bArr2[i2] = new byte[this.columns];
                i2++;
            }
            bArr2[0][0] = (byte) bArr2.length;
            this.padded = null;
        ...
        for (int i = 0; i < this.rounds; i++) {
            ...
            for (int i3 = 0; i3 < 8; i3++) {
                for (int i4 = 0; i4 < this.columns; i4++) {
                    ...
                    bArr2[i4][i3] = sBoxes[i3 % 4][bArr2[i4][i3] & 255];
                }
            }
            int i5 = 0;
            int i6 = -1;
            while (i5 < 8) {
                ...
                while (true) {
                    ...
                    this.tempBuffer[(i7 + i6) % i8] = this.tempState1[i7][i5];
                    i7++;
                }
                for (int i9 = 0; i9 < this.columns; i9++) {
                    this.tempState1[i9][i5] = this.tempBuffer[i9];
                }
                i5++;
            }
        ...
        for (int i = 0; i < this.rounds; i++) {
            ...
            for (int i3 = 0; i3 < 8; i3++) {
                for (int i4 = 0; i4 < this.columns; i4++) {
                    ...
                    bArr[i4][i3] = sBoxes[i3 % 4][bArr[i4][i3] & 255];
                }
            }
            int i5 = 0;
            int i6 = -1;
            while (i5 < 8) {
                ...
                while (true) {
                    ...
                    this.tempBuffer[(i7 + i6) % i8] = this.tempState2[i7][i5];
                    i7++;
                }
                for (int i9 = 0; i9 < this.columns; i9++) {
                    this.tempState2[i9][i5] = this.tempBuffer[i9];
                }
                i5++;
            }
            for (int i10 = 0; i10 < this.columns; i10++) {
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        for (int i5 = 0; i5 < this.rounds; i5++) {
            ...
            for (int i7 = 0; i7 < 8; i7++) {
                for (int i8 = 0; i8 < this.columns; i8++) {
                    bArr2[i8][i7] = sBoxes[i7 % 4][bArr2[i8][i7] & 255];
                }
            }
            int i9 = 0;
            int i10 = -1;
            while (i9 < 8) {
                i10 = (i9 == 7 && this.columns == 16) ? 11 : i10 + 1;
                int i11 = 0;
                while (true) {
                    ...
                    this.tempBuffer[(i11 + i10) % i12] = bArr2[i11][i9];
                    i11++;
                }
                for (int i13 = 0; i13 < this.columns; i13++) {
                    bArr2[i13][i9] = this.tempBuffer[i13];
                }
                i9++;
            }
        ...
        byte[] bArr6 = new byte[(this.columns * 8)];
        int i20 = 0;
        int i21 = 0;
        while (i20 < this.columns) {
            int i22 = i21;
            for (int i23 = 0; i23 < 8; i23++) {
                bArr6[i22] = this.state[i20][i23];
                i22++;
            }
            i20++;
            i21 = i22;
        ...
        System.arraycopy(bArr6, length2 - i24, bArr, i, i24);
        reset();
