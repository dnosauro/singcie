...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest2) {
        ...
        if (digest2 instanceof ExtendedDigest) {
            this.f7754u = digest2.getDigestSize();
            this.f7755v = ((ExtendedDigest) digest2).getByteLength();
            return;
        }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        byte[] bArr;
        byte[] bArr2;
        byte[] bArr3 = new byte[this.f7755v];
        ...
        byte[] bArr6 = new byte[this.f7755v];
        int i10 = this.f7754u;
        ...
        for (int i12 = 1; i12 <= i11; i12++) {
            ...
            if (i12 == i11) {
                ...
                System.arraycopy(bArr7, 0, bArr4, (i12 - 1) * this.f7754u, bArr7.length);
            }
        }
        return bArr4;
    }
