    ...
    private int procedure_A(int i, int i2, BigInteger[] bigIntegerArr, int i3) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                int i17 = i11 + 1;
                BigInteger add = TWO.pow(iArr[i11] - 1).divide(bigIntegerArr4[i17]).add(TWO.pow(iArr[i11] - 1).multiply(bigInteger7).divide(bigIntegerArr4[i17].multiply(TWO.pow(i13 * 16))));
    ...
    private long procedure_Aa(long j, long j2, BigInteger[] bigIntegerArr, int i) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                int i13 = i6 + 1;
                BigInteger add = TWO.pow(iArr[i6] - 1).divide(bigIntegerArr4[i13]).add(TWO.pow(iArr[i6] - 1).multiply(bigInteger7).divide(bigIntegerArr4[i13].multiply(TWO.pow(i9 * 32))));
                if (add.mod(TWO).compareTo(ONE) == 0) {
                    add = add.add(ONE);
                }
                int i14 = 0;
