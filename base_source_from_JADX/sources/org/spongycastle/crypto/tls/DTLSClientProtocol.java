        ...
        while (true) {
            ...
            if (receiveMessage.getType() == 3) {
                if (dTLSRecordLayer.getReadVersion().isEqualOrEarlierVersionOf(clientHandshakeState.clientContext.getClientVersion())) {
                    dTLSRecordLayer.setReadVersion((ProtocolVersion) null);
                ...
                if (clientHandshakeState.resumedSession) {
                    ...
                    processFinished(dTLSReliableHandshake.receiveMessageBody(20), TlsUtils.calculateVerifyData(clientHandshakeState.clientContext, ExporterLabel.server_finished, TlsProtocol.getCurrentPRFHash(clientHandshakeState.clientContext, dTLSReliableHandshake.getHandshakeHash(), (byte[]) null)));
                    dTLSReliableHandshake.sendMessage(20, TlsUtils.calculateVerifyData(clientHandshakeState.clientContext, ExporterLabel.client_finished, TlsProtocol.getCurrentPRFHash(clientHandshakeState.clientContext, dTLSReliableHandshake.getHandshakeHash(), (byte[]) null)));
                ...
                if (clientHandshakeState.selectedSessionID.length > 0) {
                    clientHandshakeState.tlsSession = new TlsSessionImpl(clientHandshakeState.selectedSessionID, (SessionParameters) null);
                }
                ...
                if (receiveMessage2.getType() == 23) {
                    ...
                    clientHandshakeState.client.processServerSupplementalData((Vector) null);
                }
                ...
                if (message.getType() != 14) {
                    ...
                    securityParameters.sessionHash = TlsProtocol.getCurrentPRFHash(clientHandshakeState.clientContext, prepareToFinish, (byte[]) null);
