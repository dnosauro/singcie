...
public class TlsStreamCipher implements TlsCipher {
    ...
    public byte[] decodeCiphertext(long j, short s, byte[] bArr, int i, int i2) {
        ...
        if (i3 >= size) {
            ...
            byte[] bArr3 = bArr2;
            this.decryptCipher.processBytes(bArr, i, i2, bArr3, 0);
            checkMAC(j, s, bArr3, i4, i2, bArr2, 0, i4);
    ...
    public byte[] encodePlaintext(long j, short s, byte[] bArr, int i, int i2) {
        ...
        byte[] calculateMac = this.writeMac.calculateMac(j, s, bArr3, i3, i4);
    ...
    public void updateIV(StreamCipher streamCipher, boolean z, long j) {
        ...
        streamCipher.init(z, new ParametersWithIV((CipherParameters) null, bArr));
    }
}
