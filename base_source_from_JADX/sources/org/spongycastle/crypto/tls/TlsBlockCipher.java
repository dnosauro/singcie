...
public class TlsBlockCipher implements TlsCipher {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:16:0x0033 A[LOOP:1: B:14:0x002f->B:16:0x0033, LOOP_END] */
        ...
        if (i5 >= max) {
            ...
            if (i6 % blockSize == 0) {
                ...
                if (!this.encryptThenMAC) {
                    ...
                    i3 = i8;
                    bArr2 = bArr3;
                    z |= !Arrays.constantTimeAreEqual(this.readMac.calculateMacConstantTime(j, s, bArr, i8, i12, i9 - size, this.randomData), Arrays.copyOfRange(bArr3, i13, i13 + size));
                } else {
                    i3 = i8;
                    bArr2 = bArr3;
                }
