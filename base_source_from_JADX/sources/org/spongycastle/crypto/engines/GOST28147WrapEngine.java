...
public class GOST28147WrapEngine implements Wrapper {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        this.mac.init(new ParametersWithIV((KeyParameter) (parametersWithUKM.getParameters() instanceof ParametersWithSBox ? ((ParametersWithSBox) parametersWithUKM.getParameters()).getParameters() : parametersWithUKM.getParameters()), parametersWithUKM.getUKM()));
    }
