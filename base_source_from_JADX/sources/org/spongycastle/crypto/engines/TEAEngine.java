...
public class TEAEngine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i4 = 0; i4 != 32; i4++) {
            bytesToInt2 -= (((bytesToInt << 4) + this.f7728_c) ^ (bytesToInt + i3)) ^ ((bytesToInt >>> 5) + this.f7729_d);
            bytesToInt -= (((bytesToInt2 << 4) + this.f7726_a) ^ (bytesToInt2 + i3)) ^ ((bytesToInt2 >>> 5) + this.f7727_b);
            i3 += 1640531527;
        }
    ...
    private void setKey(byte[] bArr) {
        if (bArr.length == 16) {
            this.f7726_a = bytesToInt(bArr, 0);
            this.f7727_b = bytesToInt(bArr, 4);
            this.f7728_c = bytesToInt(bArr, 8);
            this.f7729_d = bytesToInt(bArr, 12);
            return;
        }
