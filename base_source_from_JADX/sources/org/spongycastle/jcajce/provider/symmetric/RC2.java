...
public final class RC2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        /* renamed from: iv */
        private byte[] f7948iv;
        private int parameterVersion = 58;

        /* access modifiers changed from: protected */
        public byte[] engineGetEncoded() {
            return Arrays.clone(this.f7948iv);
        }
        ...
        public void engineInit(java.security.spec.AlgorithmParameterSpec r3) {
            /*
                r2 = this;
            ...
            L_0x002a:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.jcajce.provider.symmetric.RC2.AlgParams.engineInit(java.security.spec.AlgorithmParameterSpec):void");
        }

        /* access modifiers changed from: protected */
        public void engineInit(byte[] bArr) {
            this.f7948iv = Arrays.clone(bArr);
        }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) {
            ...
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (i = this.parameterVersion) != -1) {
                return i < 256 ? new RC2ParameterSpec(ekb[i], this.f7948iv) : new RC2ParameterSpec(i, this.f7948iv);
            }
            if (cls == IvParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new IvParameterSpec(this.f7948iv);
            }
