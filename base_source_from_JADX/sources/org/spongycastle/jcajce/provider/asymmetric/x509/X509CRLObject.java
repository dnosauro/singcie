...
class X509CRLObject extends X509CRL {
    ...
    /* renamed from: c */
    private CertificateList f7940c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) {
        if (this.f7940c.getSignatureAlgorithm().equals(this.f7940c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f7940c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f7940c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.isHashCodeSet || !x509CRLObject.isHashCodeSet || x509CRLObject.hashCodeValue == this.hashCodeValue) {
            return this.f7940c.equals(x509CRLObject.f7940c);
        }
        return false;
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f7940c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f7940c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f7940c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f7940c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f7940c.getNextUpdate() != null) {
            return this.f7940c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f7940c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f7940c.getSignature().getOctets();
    }

    public byte[] getTBSCertList() {
        try {
            return this.f7940c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f7940c.getThisUpdate().getDate();
    }

    public int getVersion() {
        return this.f7940c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f7940c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f7940c.getIssuer();
    ...
    public java.lang.String toString() {
        ...
        L_0x0097:
            ...
            goto L_0x0071
        L_0x00a0:
            org.spongycastle.asn1.x509.CertificateList r2 = r8.f7940c
