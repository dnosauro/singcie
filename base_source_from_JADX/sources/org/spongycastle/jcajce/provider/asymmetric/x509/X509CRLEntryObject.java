...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f7939c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f7939c.equals(((X509CRLEntryObject) obj).f7939c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f7939c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f7939c.getRevocationDate().getDate();
    }

    public BigInteger getSerialNumber() {
        return this.f7939c.getUserCertificate().getValue();
    }

    public boolean hasExtensions() {
        return this.f7939c.getExtensions() != null;
    }
