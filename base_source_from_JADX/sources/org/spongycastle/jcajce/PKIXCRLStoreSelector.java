...
public class PKIXCRLStoreSelector<T extends CRL> implements Selector<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0067, code lost:
        if (org.spongycastle.util.Arrays.areEqual(r0, r1) == false) goto L_0x0069;
     */
    ...
    public boolean match(java.security.cert.CRL r5) {
        ...
        L_0x000b:
            ...
            r1 = 0
            r2 = 0
            org.spongycastle.asn1.ASN1ObjectIdentifier r3 = org.spongycastle.asn1.x509.Extension.deltaCRLIndicator     // Catch:{ Exception -> 0x0069 }
            java.lang.String r3 = r3.getId()     // Catch:{ Exception -> 0x0069 }
            byte[] r3 = r0.getExtensionValue(r3)     // Catch:{ Exception -> 0x0069 }
            if (r3 == 0) goto L_0x0028
            org.spongycastle.asn1.ASN1OctetString r1 = org.spongycastle.asn1.ASN1OctetString.getInstance(r3)     // Catch:{ Exception -> 0x0069 }
            byte[] r1 = r1.getOctets()     // Catch:{ Exception -> 0x0069 }
            org.spongycastle.asn1.ASN1Integer r1 = org.spongycastle.asn1.ASN1Integer.getInstance(r1)     // Catch:{ Exception -> 0x0069 }
        L_0x0028:
        ...
        L_0x004e:
            ...
            return r2
        L_0x0063:
            boolean r0 = org.spongycastle.util.Arrays.areEqual((byte[]) r0, (byte[]) r1)
            if (r0 != 0) goto L_0x0004
        L_0x0069:
            return r2
        */
