...
public class IndexGenerator {
    ...
    IndexGenerator(byte[] bArr, NTRUEncryptionParameters nTRUEncryptionParameters) {
        this.seed = bArr;
        this.f8169N = nTRUEncryptionParameters.f8178N;
        this.f8170c = nTRUEncryptionParameters.f8179c;
    ...
    public int nextIndex() {
        ...
        do {
            ...
            leadingAsInt = trailing.getLeadingAsInt(this.f8170c);
            i = this.f8170c;
            i2 = this.f8169N;
