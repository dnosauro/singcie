...
public class NTRUSigningKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public class FGBasis extends NTRUSigningPrivateKeyParameters.Basis {
        ...
        /* renamed from: F */
        public IntegerPolynomial f8196F;

        /* renamed from: G */
        public IntegerPolynomial f8197G;
        ...
        FGBasis(Polynomial polynomial, Polynomial polynomial2, IntegerPolynomial integerPolynomial, IntegerPolynomial integerPolynomial2, IntegerPolynomial integerPolynomial3, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters) {
            ...
            this.f8196F = integerPolynomial2;
            this.f8197G = integerPolynomial3;
        }
        ...
        public boolean isNormOk() {
            ...
            return ((double) this.f8196F.centeredNormSq(i)) < d && ((double) this.f8197G.centeredNormSq(i)) < d;
        }
    }
    ...
    private FGBasis generateBasis() {
        ...
        int i4 = this.params.f8190N;
        int i5 = this.params.f8195q;
        int i6 = this.params.f8191d;
        int i7 = this.params.f8192d1;
        int i8 = this.params.f8193d2;
        int i9 = this.params.f8194d3;
        ...
        bigIntPolynomial2.mult(calculate.f8248x.multiply(BigInteger.valueOf((long) i5)));
        BigIntPolynomial bigIntPolynomial3 = (BigIntPolynomial) resultant2.rho.clone();
        bigIntPolynomial3.mult(calculate.f8249y.multiply(BigInteger.valueOf((long) (-i5))));
        int i17 = 0;
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        int i2 = this.params.f8189B;
        while (i2 >= 0) {
            Future future = (Future) arrayList.get(i2);
            try {
                arrayList2.add(future.get());
                if (i2 == this.params.f8189B) {
                    nTRUSigningPublicKeyParameters = new NTRUSigningPublicKeyParameters(((NTRUSigningPrivateKeyParameters.Basis) future.get()).f8206h, this.params.getSigningParameters());
                }
                i2--;
            } catch (Exception e) {
    ...
    public AsymmetricCipherKeyPair generateKeyPairSingleThread() {
        ...
        for (int i = this.params.f8189B; i >= 0; i--) {
            NTRUSigningPrivateKeyParameters.Basis generateBoundedBasis = generateBoundedBasis();
            arrayList.add(generateBoundedBasis);
            if (i == 0) {
                nTRUSigningPublicKeyParameters = new NTRUSigningPublicKeyParameters(generateBoundedBasis.f8206h, this.params.getSigningParameters());
            }
        }
