...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            bArr3[i4] = (byte[][]) Array.newInstance(byte.class, new int[]{this.heightOfTrees[i4], this.mdLength});
            int[] iArr = this.heightOfTrees;
            treehashArr[i4] = new Treehash[(iArr[i4] - this.f8114K[i4])];
            if (i4 > 0) {
                int i5 = i4 - 1;
                bArr4[i5] = (byte[][]) Array.newInstance(byte.class, new int[]{iArr[i4], this.mdLength});
                treehashArr2[i5] = new Treehash[(this.heightOfTrees[i4] - this.f8114K[i4])];
            }
        ...
        byte[][] bArr5 = (byte[][]) Array.newInstance(byte.class, new int[]{i, this.mdLength});
        ...
        byte[][] bArr8 = bArr6;
        this.currentRootSigs = (byte[][]) Array.newInstance(byte.class, new int[]{i2 - 1, this.mdLength});
        int i7 = this.numLayer - 1;
        while (i7 >= 0) {
            GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i7], this.f8114K[i7], this.digestProvider);
            try {
                ...
                gMSSRootCalc = generateCurrentAuthpathAndRoot(bArr, vector, bArr2, i7);
            } catch (Exception e) {
                e.printStackTrace();
            }
            int i8 = 0;
            while (i8 < this.heightOfTrees[i7]) {
                System.arraycopy(gMSSRootCalc.getAuthPath()[i8], 0, bArr3[i7][i8], 0, this.mdLength);
                i8++;
                vectorArr = vectorArr;
                bArr3 = bArr3;
            }
            ...
            System.arraycopy(gMSSRootCalc.getRoot(), 0, bArr5[i7], 0, this.mdLength);
            i7--;
            vectorArr = vectorArr;
            bArr3 = bArr3;
        }
        ...
        while (i9 >= 0) {
            ...
            System.arraycopy(generateNextAuthpathAndRoot.getRoot(), 0, bArr8[i9], 0, this.mdLength);
        ...
        byte[][] bArr10 = this.currentSeeds;
        byte[][] bArr11 = this.nextNextSeeds;
        byte[][] bArr12 = this.currentRootSigs;
        ...
        GMSSPrivateKeyParameters gMSSPrivateKeyParameters2 = new GMSSPrivateKeyParameters(bArr10, bArr11, bArr9, bArr4, treehashArr, treehashArr2, vectorArr5, vectorArr2, vectorArr3, vectorArr4, bArr8, bArr12, gMSSParameters, gMSSDigestProvider);
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f8114K[i], this.digestProvider);
        ...
        while (true) {
            ...
            if (i3 == i4 && i5 < iArr[i] - this.f8114K[i]) {
    ...
    private GMSSRootCalc generateNextAuthpathAndRoot(Vector vector, byte[] bArr, int i) {
        ...
        while (true) {
            ...
            if (i2 == i3 && i4 < iArr[i] - this.f8114K[i]) {
