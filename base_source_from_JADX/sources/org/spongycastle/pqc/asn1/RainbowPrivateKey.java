...
public class RainbowPrivateKey extends ASN1Object {
    ...
    /* renamed from: b1 */
    private byte[] f8111b1;

    /* renamed from: b2 */
    private byte[] f8112b2;
    private byte[][] invA1;
    private byte[][] invA2;
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f8111b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence2.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f8112b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence2.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f8113vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence2.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f8113vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            byte[] bArr5 = this.f8113vi;
            int i11 = i10 + 1;
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f8111b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f8112b2 = RainbowUtil.convertArray(sArr4);
        this.f8113vi = RainbowUtil.convertIntArray(iArr);
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f8111b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f8112b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f8113vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f8111b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f8112b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f8113vi));
        ...
        for (int i3 = 0; i3 < this.layers.length; i3++) {
            ...
            for (int i4 = 0; i4 < convertArray.length; i4++) {
                ...
                for (byte[] dEROctetString : convertArray[i4]) {
                    aSN1EncodableVector10.add(new DEROctetString(dEROctetString));
                }
            ...
            for (int i5 = 0; i5 < convertArray2.length; i5++) {
                ASN1EncodableVector aSN1EncodableVector12 = new ASN1EncodableVector();
                for (byte[] dEROctetString2 : convertArray2[i5]) {
                    aSN1EncodableVector12.add(new DEROctetString(dEROctetString2));
                }
            ...
            for (byte[] dEROctetString3 : convertArray3) {
                aSN1EncodableVector13.add(new DEROctetString(dEROctetString3));
            }
