    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        while (i4 < treehashArr3.length) {
            ...
            while (i5 < treehashArr3[i4].length) {
                ...
                int i7 = 0;
                while (i7 < i6) {
                    aSN1EncodableVector20.add(new DEROctetString(treehashArr3[i4][i5].getStatByte()[i7 + 3]));
                    i7++;
                ...
                int i8 = 0;
                while (i8 < i6) {
                    aSN1EncodableVector19.add(new ASN1Integer((long) treehashArr3[i4][i5].getStatInt()[i8 + 6]));
                    i8++;
                    byte[][][] bArr13 = bArr5;
        ...
        while (i9 < treehashArr4.length) {
            ...
            for (int i10 = 0; i10 < treehashArr4[i9].length; i10++) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    aSN1EncodableVector31.add(new DEROctetString(treehashArr4[i9][i10].getStatByte()[i12 + 3]));
                }
                ...
                for (int i13 = 0; i13 < i11; i13++) {
                    aSN1EncodableVector30.add(new ASN1Integer((long) treehashArr4[i9][i10].getStatInt()[i13 + 6]));
                }
        ...
        while (i29 < gMSSRootCalcArr2.length) {
            ...
            while (i32 < i30) {
                i32++;
                aSN1EncodableVector77.add(new DEROctetString(gMSSRootCalcArr2[i29].getStatByte()[i32]));
            }
            for (int i33 = 0; i33 < i31; i33++) {
                aSN1EncodableVector77.add(new DEROctetString(gMSSRootCalcArr2[i29].getStatByte()[i30 + 1 + i33]));
            }
            ...
            aSN1EncodableVector78.add(new ASN1Integer((long) i30));
            ...
            for (int i34 = 0; i34 < i30; i34++) {
                aSN1EncodableVector78.add(new ASN1Integer((long) gMSSRootCalcArr2[i29].getStatInt()[i34 + 8]));
            }
            for (int i35 = 0; i35 < i31; i35++) {
                aSN1EncodableVector78.add(new ASN1Integer((long) gMSSRootCalcArr2[i29].getStatInt()[i30 + 8 + i35]));
            }
            ...
            if (gMSSRootCalcArr2[i29].getTreehash() != null) {
                ...
                while (i36 < gMSSRootCalcArr2[i29].getTreehash().length) {
                    ...
                    aSN1EncodableVector86.add(new DEROctetString(gMSSRootCalcArr2[i29].getTreehash()[i36].getStatByte()[0]));
                    aSN1EncodableVector86.add(new DEROctetString(gMSSRootCalcArr2[i29].getTreehash()[i36].getStatByte()[1]));
                    aSN1EncodableVector86.add(new DEROctetString(gMSSRootCalcArr2[i29].getTreehash()[i36].getStatByte()[2]));
                    int i38 = 0;
                    while (i38 < i37) {
                        aSN1EncodableVector86.add(new DEROctetString(gMSSRootCalcArr2[i29].getTreehash()[i36].getStatByte()[i38 + 3]));
                        i38++;
                    ...
                    aSN1EncodableVector85.add(new ASN1Integer((long) gMSSRootCalcArr2[i29].getTreehash()[i36].getStatInt()[0]));
                    aSN1EncodableVector85.add(new ASN1Integer((long) i37));
                    aSN1EncodableVector85.add(new ASN1Integer((long) gMSSRootCalcArr2[i29].getTreehash()[i36].getStatInt()[2]));
                    aSN1EncodableVector85.add(new ASN1Integer((long) gMSSRootCalcArr2[i29].getTreehash()[i36].getStatInt()[3]));
                    aSN1EncodableVector85.add(new ASN1Integer((long) gMSSRootCalcArr2[i29].getTreehash()[i36].getStatInt()[4]));
                    aSN1EncodableVector85.add(new ASN1Integer((long) gMSSRootCalcArr2[i29].getTreehash()[i36].getStatInt()[5]));
                    for (int i39 = 0; i39 < i37; i39++) {
                        aSN1EncodableVector85.add(new ASN1Integer((long) gMSSRootCalcArr2[i29].getTreehash()[i36].getStatInt()[i39 + 6]));
                    }
            ...
            if (gMSSRootCalcArr2[i29].getRetain() != null) {
                ...
                for (int i40 = 0; i40 < gMSSRootCalcArr2[i29].getRetain().length; i40++) {
                    for (int i41 = 0; i41 < gMSSRootCalcArr2[i29].getRetain()[i40].size(); i41++) {
                        aSN1EncodableVector95.add(new DEROctetString((byte[]) gMSSRootCalcArr2[i29].getRetain()[i40].elementAt(i41)));
                    }
        ...
        for (int i42 = 0; i42 < gMSSRootSigArr2.length; i42++) {
            ...
            new ASN1EncodableVector();
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[0]));
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[1]));
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[2]));
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[3]));
            aSN1EncodableVector100.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[4]));
            aSN1EncodableVector102.add(new DERSequence(aSN1EncodableVector100));
            aSN1EncodableVector100 = new ASN1EncodableVector();
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[0]));
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[1]));
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[2]));
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[3]));
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[4]));
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[5]));
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[6]));
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[7]));
            aSN1EncodableVector101.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[8]));
        ...
        for (int i43 = 0; i43 < gMSSParameters.getHeightOfTrees().length; i43++) {
            aSN1EncodableVector104.add(new ASN1Integer((long) gMSSParameters.getHeightOfTrees()[i43]));
            aSN1EncodableVector105.add(new ASN1Integer((long) gMSSParameters.getWinternitzParameter()[i43]));
            aSN1EncodableVector106.add(new ASN1Integer((long) gMSSParameters.getK()[i43]));
        }
