...
public class GF2Polynomial {
    ...
    public void reducePentanomial(int i, int[] iArr) {
        ...
        while (i12 > i3) {
            ...
            long j = ((long) iArr2[i12]) & BodyPartID.bodyIdMax;
            int i13 = i12 - i3;
            int i14 = i13 - 1;
            int i15 = i3;
            int i16 = i4;
        ...
        long j2 = ((long) iArr3[i24]) & BodyPartID.bodyIdMax & (BodyPartID.bodyIdMax << i25);
        ...
        int[] iArr4 = this.value;
        iArr4[i26] = (int) (((long) iArr4[i26]) ^ (j2 >>> (32 - i7)));
        int i28 = i24 - i8;
        int i29 = i28 - 1;
        if (i29 >= 0) {
            iArr4[i29] = iArr4[i29] ^ ((int) (j2 << i9));
        }
        int[] iArr5 = this.value;
        iArr5[i28] = (int) (((long) iArr5[i28]) ^ (j2 >>> (32 - i9)));
        int i30 = i24 - i10;
        int i31 = i30 - 1;
        if (i31 >= 0) {
            iArr5[i31] = iArr5[i31] ^ ((int) (j2 << i11));
        }
        int[] iArr6 = this.value;
        iArr6[i30] = (int) ((j2 >>> (32 - i11)) ^ ((long) iArr6[i30]));
        iArr6[i24] = iArr6[i24] & reverseRightMask[i25];
        int i32 = i;
    ...
    public void reduceTrinomial(int i, int i2) {
        ...
        int[] iArr3 = this.value;
        iArr3[i18] = (int) ((j2 >>> (32 - i9)) ^ ((long) iArr3[i18]));
        iArr3[i17] = iArr3[i17] & reverseRightMask[i5];
        int i20 = i;
        ...
        if (!isZero()) {
            ...
            if (length >= (i3 << 1)) {
                for (int i4 = i3 - 1; i4 >= 0; i4--) {
                    ...
                    iArr[i5] = sArr[iArr[i4] & 255] | (sArr[(iArr[i4] & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB) >>> 8] << 16);
                }
                i = this.blocks << 1;
            } else {
                ...
                while (true) {
                    ...
                    int[] iArr3 = this.value;
                    iArr2[i7] = sArr2[iArr3[i6] & 255] | (sArr2[(iArr3[i6] & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB) >>> 8] << 16);
