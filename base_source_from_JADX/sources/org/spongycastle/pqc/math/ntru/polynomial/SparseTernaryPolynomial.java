...
public class SparseTernaryPolynomial implements TernaryPolynomial {
    ...
    public SparseTernaryPolynomial(int[] iArr) {
        this.f8255N = iArr.length;
        int i = this.f8255N;
        this.ones = new int[i];
        this.negOnes = new int[i];
        int i2 = 0;
        int i3 = 0;
        for (int i4 = 0; i4 < this.f8255N; i4++) {
            int i5 = iArr[i4];
            switch (i5) {
                case -1:
                    this.negOnes[i3] = i4;
    ...
    public boolean equals(Object obj) {
        ...
        return this.f8255N == sparseTernaryPolynomial.f8255N && Arrays.areEqual(this.negOnes, sparseTernaryPolynomial.negOnes) && Arrays.areEqual(this.ones, sparseTernaryPolynomial.ones);
    }
    ...
    public int hashCode() {
        return ((((this.f8255N + 31) * 31) + Arrays.hashCode(this.negOnes)) * 31) + Arrays.hashCode(this.ones);
    }
    ...
    public BigIntPolynomial mult(BigIntPolynomial bigIntPolynomial) {
        ...
        if (length == i) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < this.f8255N; i3++) {
