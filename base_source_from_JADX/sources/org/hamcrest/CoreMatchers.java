...
import org.hamcrest.core.C3352Is;
...
public class CoreMatchers {
    ...
    /* renamed from: is */
    public static <T> Matcher<T> m9121is(Class<T> cls) {
        return C3352Is.m9126is(cls);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m9122is(T t) {
        return C3352Is.m9127is(t);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m9123is(Matcher<T> matcher) {
        return C3352Is.m9128is(matcher);
    }

    public static <T> Matcher<T> isA(Class<T> cls) {
        return C3352Is.isA(cls);
    }
