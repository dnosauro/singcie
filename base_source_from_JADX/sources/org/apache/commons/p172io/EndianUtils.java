...
public class EndianUtils {
    ...
    public static int readSwappedInteger(byte[] bArr, int i) {
        return ((bArr[i + 0] & 255) << 0) + ((bArr[i + 1] & 255) << 8) + ((bArr[i + 2] & 255) << Tnaf.POW_2_WIDTH) + ((bArr[i + 3] & 255) << 24);
    }
    ...
    public static long readSwappedLong(byte[] bArr, int i) {
        return (((long) (((((bArr[i + 4] & 255) << 0) + ((bArr[i + 5] & 255) << 8)) + ((bArr[i + 6] & 255) << Tnaf.POW_2_WIDTH)) + ((bArr[i + 7] & 255) << 24))) << 32) + (((long) (((bArr[i + 0] & 255) << 0) + ((bArr[i + 1] & 255) << 8) + ((bArr[i + 2] & 255) << Tnaf.POW_2_WIDTH) + ((bArr[i + 3] & 255) << 24))) & BodyPartID.bodyIdMax);
    }
    ...
    public static long readSwappedUnsignedInteger(InputStream inputStream) {
        return (((long) (read(inputStream) & 255)) << 24) + (((long) (((read(inputStream) & 255) << 0) + ((read(inputStream) & 255) << 8) + ((read(inputStream) & 255) << 16))) & BodyPartID.bodyIdMax);
    }

    public static long readSwappedUnsignedInteger(byte[] bArr, int i) {
        return (((long) (bArr[i + 3] & 255)) << 24) + (((long) (((bArr[i + 0] & 255) << 0) + ((bArr[i + 1] & 255) << 8) + ((bArr[i + 2] & 255) << Tnaf.POW_2_WIDTH))) & BodyPartID.bodyIdMax);
    }
