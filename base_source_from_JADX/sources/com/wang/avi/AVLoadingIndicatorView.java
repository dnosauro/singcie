...
public class AVLoadingIndicatorView extends View {
    ...
    public AVLoadingIndicatorView(Context context, AttributeSet attributeSet) {
        ...
        init(context, attributeSet, 0, C3131R.C3132style.AVLoadingIndicatorView);
    }

    public AVLoadingIndicatorView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        init(context, attributeSet, i, C3131R.C3132style.AVLoadingIndicatorView);
    }
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mMinHeight = 24;
        this.mMaxHeight = 48;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C3131R.styleable.AVLoadingIndicatorView, i, i2);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C3131R.styleable.AVLoadingIndicatorView_minWidth, this.mMinWidth);
        this.mMaxWidth = obtainStyledAttributes.getDimensionPixelSize(C3131R.styleable.AVLoadingIndicatorView_maxWidth, this.mMaxWidth);
        this.mMinHeight = obtainStyledAttributes.getDimensionPixelSize(C3131R.styleable.AVLoadingIndicatorView_minHeight, this.mMinHeight);
        this.mMaxHeight = obtainStyledAttributes.getDimensionPixelSize(C3131R.styleable.AVLoadingIndicatorView_maxHeight, this.mMaxHeight);
        String string = obtainStyledAttributes.getString(C3131R.styleable.AVLoadingIndicatorView_indicatorName);
        this.mIndicatorColor = obtainStyledAttributes.getColor(C3131R.styleable.AVLoadingIndicatorView_indicatorColor, -1);
        setIndicator(string);
        ...
        if (indicator != null) {
            ...
            if (intrinsicWidth != f3) {
                if (f3 > intrinsicWidth) {
                    ...
                    i3 = (paddingTop - i8) / 2;
                    i4 = i8 + i3;
                    this.mIndicator.setBounds(i5, i3, paddingRight, i4);
                }
            }
            i4 = paddingTop;
            i3 = 0;
