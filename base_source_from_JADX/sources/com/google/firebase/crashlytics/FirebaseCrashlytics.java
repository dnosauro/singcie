...
public class FirebaseCrashlytics {
    ...
    private static AnalyticsConnector.AnalyticsConnectorHandle subscribeToAnalyticsEvents(AnalyticsConnector analyticsConnector, CrashlyticsAnalyticsListener crashlyticsAnalyticsListener) {
        ...
        if (registerAnalyticsConnectorListener == null) {
            Logger.getLogger().mo21676d("Could not register AnalyticsConnectorListener with Crashlytics origin.");
            ...
            if (registerAnalyticsConnectorListener != null) {
                Logger.getLogger().mo21686w("A new version of the Google Analytics for Firebase SDK is now available. For improved performance and compatibility with Crashlytics, please update to the latest version.");
            }
        }
    ...
    public void recordException(Throwable th) {
        if (th == null) {
            Logger.getLogger().mo21686w("Crashlytics is ignoring a request to log a null exception.");
        } else {
