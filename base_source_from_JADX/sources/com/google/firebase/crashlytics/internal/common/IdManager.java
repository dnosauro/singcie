...
public class IdManager implements InstallIdProvider {
    ...
    private synchronized String createAndStoreIid(String str, SharedPreferences sharedPreferences) {
        ...
        logger.mo21676d("Created new Crashlytics IID: " + formatId);
    ...
    private synchronized void migrateLegacyId(String str, String str2, SharedPreferences sharedPreferences, SharedPreferences sharedPreferences2) {
        Logger logger = Logger.getLogger();
        logger.mo21676d("Migrating legacy Crashlytics IID: " + str);
    ...
    public synchronized String getCrashlyticsInstallId() {
        ...
        try {
            ...
            Logger.getLogger().mo21677d("Failed to retrieve installation id", e);
        ...
        if (string == null) {
            ...
            Logger logger = Logger.getLogger();
            logger.mo21676d("No cached FID; legacy id is " + string2);
            if (string2 == null) {
        ...
        if (string.equals(str)) {
            ...
            logger2.mo21676d("Found matching FID, using Crashlytics IID: " + this.crashlyticsInstallId);
            if (this.crashlyticsInstallId == null) {
                createAndStoreIid = createAndStoreIid(str, sharedPrefs);
            }
            return this.crashlyticsInstallId;
        }
        createAndStoreIid = createAndStoreIid(str, sharedPrefs);
