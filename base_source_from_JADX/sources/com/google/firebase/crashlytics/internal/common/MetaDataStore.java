    ...
    public Map<String, String> readKeyData(String str) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo21679e("Error deserializing user metadata.", e);
    ...
    public void writeKeyData(String str, Map<String, String> map) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo21679e("Error serializing key/value metadata.", e);
    ...
    public void writeUserData(String str, UserMetadata userMetadata) {
        ...
        try {
            ...
            try {
                ...
                bufferedWriter = bufferedWriter2;
                try {
                    Logger.getLogger().mo21679e("Error serializing user metadata.", e);
