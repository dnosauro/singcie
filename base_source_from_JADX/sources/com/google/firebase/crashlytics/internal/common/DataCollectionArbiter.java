...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z) {
        Logger.getLogger().mo21676d(String.format("Crashlytics automatic data collection %s by %s.", new Object[]{z ? "ENABLED" : "DISABLED", this.crashlyticsDataCollectionEnabled == null ? "global Firebase setting" : this.setInManifest ? "firebase_crashlytics_collection_enabled manifest flag" : "API"}));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().mo21677d("Unable to get PackageManager. Falling through", e);
            return null;
        }
    }
