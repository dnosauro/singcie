...
public class CommonUtils {
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().mo21676d("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Logger.getLogger().mo21679e(str, e);
            }
        }
    }
            ...
            try {
                ...
                while (true) {
                    try {
                        ...
                        e = e;
                        try {
                            Logger.getLogger().mo21679e("Error parsing " + file, e);
    ...
    public static String getAppIconHashOrNull(Context context) {
        ...
        try {
            ...
            try {
                ...
                e = e;
                try {
                    Logger.getLogger().mo21686w("Could not calculate hash for app icon:" + e.getMessage());
                    closeOrLog(inputStream, "Failed to close icon input stream.");
                    return null;
                } catch (Throwable th) {
                    th = th;
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            logger.mo21676d("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                    } catch (NumberFormatException e) {
                        Logger logger2 = Logger.getLogger();
                        logger2.mo21679e("Unexpected meminfo format while computing RAM: " + upperCase, e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    private static String hash(InputStream inputStream, String str) {
        try {
            ...
            Logger.getLogger().mo21679e("Could not calculate hash for app icon.", e);
            return "";
        }
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger logger = Logger.getLogger();
            logger.mo21679e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
    ...
    public static String resolveUnityEditorVersion(Context context) {
        ...
        Logger logger = Logger.getLogger();
        logger.mo21676d("Unity Editor version is: " + string);
        return string;
    }
