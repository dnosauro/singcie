...
abstract class AbstractAppSpiCall extends AbstractSpiCall implements AppSpiCall {
    ...
    public boolean invoke(AppRequestData appRequestData, boolean z) {
        if (z) {
            ...
            logger.mo21676d("Sending app info to " + getUrl());
            try {
                ...
                logger2.mo21676d(str + " app request ID: " + execute.header(AbstractSpiCall.HEADER_REQUEST_ID));
                Logger logger3 = Logger.getLogger();
                logger3.mo21676d("Result was " + code);
                return ResponseParser.parse(code) == 0;
            } catch (IOException e) {
                Logger.getLogger().mo21679e("HTTP request failed.", e);
