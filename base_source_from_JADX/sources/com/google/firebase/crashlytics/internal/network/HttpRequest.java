...
public class HttpRequest {
    ...
    private Request build() {
        ...
        Request.Builder url2 = cacheControl.url(newBuilder.build());
        for (Map.Entry next2 : this.headers.entrySet()) {
            url2 = url2.header((String) next2.getKey(), (String) next2.getValue());
        }
        MultipartBody.Builder builder = this.bodyBuilder;
        return url2.method(this.method.name(), builder == null ? null : builder.build()).build();
    }
