...
class QueueFileLogStore implements FileLogStore {
    ...
    private void doWriteToLog(long j, String str) {
        if (this.logFile != null) {
            ...
            try {
                ...
                this.logFile.add(String.format(Locale.US, "%d %s%n", new Object[]{Long.valueOf(j), str.replaceAll("\r", " ").replaceAll(IOUtils.LINE_SEPARATOR_UNIX, " ")}).getBytes(UTF_8));
                while (!this.logFile.isEmpty() && this.logFile.usedBytes() > this.maxLogSize) {
                    this.logFile.remove();
                }
            } catch (IOException e) {
                Logger.getLogger().mo21679e("There was a problem writing to the Crashlytics log.", e);
            }
        }
    }
    ...
    private LogBytes getLogBytes() {
        ...
        try {
            ...
            Logger.getLogger().mo21679e("A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                logger.mo21679e("Could not open log file: " + this.workingFile, e);
            }
        }
    }
