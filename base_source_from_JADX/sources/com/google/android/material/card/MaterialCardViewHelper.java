...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView materialCardView2, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = materialCardView2.getContext().obtainStyledAttributes(attributeSet, C2246R.styleable.CardView, i, C2246R.C2250style.CardView);
        if (obtainStyledAttributes.hasValue(C2246R.styleable.CardView_cardCornerRadius)) {
            builder.setAllCornerSizes(obtainStyledAttributes.getDimension(C2246R.styleable.CardView_cardCornerRadius, 0.0f));
        }
        this.foregroundContentDrawable = new MaterialShapeDrawable();
        setShapeAppearanceModel(builder.build());
        Resources resources = materialCardView2.getResources();
        this.checkedIconMargin = resources.getDimensionPixelSize(C2246R.dimen.mtrl_card_checked_icon_margin);
        this.checkedIconSize = resources.getDimensionPixelSize(C2246R.dimen.mtrl_card_checked_icon_size);
    ...
    private Drawable getClickableForeground() {
        ...
        if (this.clickableForegroundDrawable == null) {
            ...
            this.clickableForegroundDrawable.setId(2, C2246R.C2249id.mtrl_card_checked_layer_id);
        }
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        this.strokeColor = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C2246R.styleable.MaterialCardView_strokeColor);
        if (this.strokeColor == null) {
            this.strokeColor = ColorStateList.valueOf(-1);
        }
        this.strokeWidth = typedArray.getDimensionPixelSize(C2246R.styleable.MaterialCardView_strokeWidth, 0);
        this.checkable = typedArray.getBoolean(C2246R.styleable.MaterialCardView_android_checkable, false);
        this.materialCardView.setLongClickable(this.checkable);
        this.checkedIconTint = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C2246R.styleable.MaterialCardView_checkedIconTint);
        setCheckedIcon(MaterialResources.getDrawable(this.materialCardView.getContext(), typedArray, C2246R.styleable.MaterialCardView_checkedIcon));
        this.rippleColor = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C2246R.styleable.MaterialCardView_rippleColor);
        if (this.rippleColor == null) {
            this.rippleColor = ColorStateList.valueOf(MaterialColors.getColor(this.materialCardView, C2246R.attr.colorControlHighlight));
        }
        ColorStateList colorStateList = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C2246R.styleable.MaterialCardView_cardForegroundColor);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            int i7 = (i - i5) - i6;
            int i8 = (i2 - i5) - i6;
            if (C0656u.m2621g(this.materialCardView) == 1) {
                i3 = i7;
                i4 = i5;
            } else {
                i4 = i7;
    ...
    public void setCheckedIcon(Drawable drawable) {
        ...
        if (drawable != null) {
            this.checkedIcon = C0595a.m2330g(drawable.mutate());
            C0595a.m2319a(this.checkedIcon, this.checkedIconTint);
        }
        if (this.clickableForegroundDrawable != null) {
            this.clickableForegroundDrawable.setDrawableByLayerId(C2246R.C2249id.mtrl_card_checked_layer_id, createCheckedIconLayer());
        }
    }
