...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2246R.styleable.ScrimInsetsFrameLayout, i, C2246R.C2250style.Widget_Design_ScrimInsetsFrameLayout, new int[0]);
        this.insetForeground = obtainStyledAttributes.getDrawable(C2246R.styleable.ScrimInsetsFrameLayout_insetForeground);
        ...
        C0656u.m2595a((View) this, (C0652q) new C0652q() {
            public C0633ac onApplyWindowInsets(View view, C0633ac acVar) {
                ...
                ScrimInsetsFrameLayout.this.insets.set(acVar.mo3782a(), acVar.mo3784b(), acVar.mo3785c(), acVar.mo3786d());
                ScrimInsetsFrameLayout.this.onInsetsChanged(acVar);
                ScrimInsetsFrameLayout.this.setWillNotDraw(!acVar.mo3787e() || ScrimInsetsFrameLayout.this.insetForeground == null);
                C0656u.m2617e(ScrimInsetsFrameLayout.this);
