...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2246R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = obtainStyledAttributes.getDimensionPixelSize(C2246R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = obtainStyledAttributes.getDimensionPixelSize(C2246R.styleable.FlowLayout_itemSpacing, 0);
            ...
            for (int i10 = 0; i10 < getChildCount(); i10++) {
                ...
                if (childAt.getVisibility() != 8) {
                    ...
                    if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                        ...
                        i5 = C0641f.m2529a(marginLayoutParams);
                        i6 = C0641f.m2531b(marginLayoutParams);
                    } else {
                        i6 = 0;
                        i5 = 0;
                    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int measuredWidth2 = i13 + i4 + i3 + childAt.getMeasuredWidth() + this.itemSpacing;
