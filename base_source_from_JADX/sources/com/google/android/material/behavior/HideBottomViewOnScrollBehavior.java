...
public class HideBottomViewOnScrollBehavior<V extends View> extends CoordinatorLayout.C0471b<V> {
    ...
    public void setAdditionalHiddenOffsetY(V v, int i) {
        ...
        if (this.currentState == 1) {
            v.setTranslationY((float) (this.height + this.additionalHiddenOffsetY));
        }
    }
