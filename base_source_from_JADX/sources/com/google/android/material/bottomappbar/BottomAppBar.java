...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.C0470a {
    private static final long ANIMATION_DURATION = 300;
    private static final int DEF_STYLE_RES = C2246R.C2250style.Widget_MaterialComponents_BottomAppBar;
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        private final View.OnLayoutChangeListener fabLayoutListener = new View.OnLayoutChangeListener() {
            public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                ...
                if (Behavior.this.originalBottomMargin == 0) {
                    int dimensionPixelOffset = bottomAppBar.getResources().getDimensionPixelOffset(C2246R.dimen.mtrl_bottomappbar_fab_bottom_margin);
                    eVar.bottomMargin = bottomAppBar.getBottomInset() + (dimensionPixelOffset - ((floatingActionButton.getMeasuredHeight() - height) / 2));
                }
            }
        };
        /* access modifiers changed from: private */
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i) {
            ...
            if (access$1700 != null && !C0656u.m2642y(access$1700)) {
                CoordinatorLayout.C0474e eVar = (CoordinatorLayout.C0474e) access$1700.getLayoutParams();
                eVar.f1895d = 49;
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2246R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2246R.styleable.BottomAppBar, i, DEF_STYLE_RES, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, obtainStyledAttributes, C2246R.styleable.BottomAppBar_backgroundTint);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C2246R.styleable.BottomAppBar_elevation, 0);
        this.fabAlignmentMode = obtainStyledAttributes.getInt(C2246R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = obtainStyledAttributes.getInt(C2246R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.hideOnScroll = obtainStyledAttributes.getBoolean(C2246R.styleable.BottomAppBar_hideOnScroll, false);
        obtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C2246R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        this.materialShapeDrawable.setShapeAppearanceModel(ShapeAppearanceModel.builder().setTopEdge(new BottomAppBarTopEdgeTreatment((float) obtainStyledAttributes.getDimensionPixelOffset(C2246R.styleable.BottomAppBar_fabCradleMargin, 0), (float) obtainStyledAttributes.getDimensionPixelOffset(C2246R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0), (float) obtainStyledAttributes.getDimensionPixelOffset(C2246R.styleable.BottomAppBar_fabCradleVerticalOffset, 0))).build());
        ...
        C0595a.m2319a((Drawable) this.materialShapeDrawable, colorStateList);
        C0656u.m2590a((View) this, (Drawable) this.materialShapeDrawable);
        ViewUtils.doOnApplyWindowInsets(this, new ViewUtils.OnApplyWindowInsetsListener() {
            public C0633ac onApplyWindowInsets(View view, C0633ac acVar, ViewUtils.RelativePadding relativePadding) {
                int unused = BottomAppBar.this.bottomInset = acVar.mo3786d();
    ...
    public float getFabTranslationX(int i) {
        int i2 = 1;
        boolean z = C0656u.m2621g(this) == 1;
        if (i != 1) {
            return 0.0f;
        }
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode != i && C0656u.m2642y(this)) {
    ...
    public int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int i, boolean z) {
        boolean z2 = C0656u.m2621g(this) == 1;
        int measuredWidth = z2 ? getMeasuredWidth() : 0;
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            View childAt = getChildAt(i2);
            if ((childAt.getLayoutParams() instanceof Toolbar.C0245b) && (((Toolbar.C0245b) childAt.getLayoutParams()).f177a & 8388615) == 8388611) {
