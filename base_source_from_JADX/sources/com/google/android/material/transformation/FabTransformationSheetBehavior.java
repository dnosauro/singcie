...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    private void updateImportantForAccessibility(View view, boolean z) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                boolean z2 = (childAt.getLayoutParams() instanceof CoordinatorLayout.C0474e) && (((CoordinatorLayout.C0474e) childAt.getLayoutParams()).mo3374b() instanceof FabTransformationScrimBehavior);
                if (childAt != view && !z2) {
                    if (!z) {
    ...
    public FabTransformationBehavior.FabTransformationSpec onCreateMotionSpec(Context context, boolean z) {
        int i = z ? C2246R.animator.mtrl_fab_transformation_sheet_expand_spec : C2246R.animator.mtrl_fab_transformation_sheet_collapse_spec;
