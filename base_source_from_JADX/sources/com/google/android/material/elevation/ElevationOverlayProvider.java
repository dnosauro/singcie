...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C2246R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C2246R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C2246R.attr.colorSurface, 0);
        this.displayDensity = context.getResources().getDisplayMetrics().density;
    }

    private boolean isThemeSurfaceColor(int i) {
        return C0589a.m2272b(i, 255) == this.colorSurface;
    }
    ...
    public int compositeOverlay(int i, float f) {
        ...
        return C0589a.m2272b(MaterialColors.layer(C0589a.m2272b(i, 255), this.elevationOverlayColor, calculateOverlayAlphaFraction), Color.alpha(i));
    }
