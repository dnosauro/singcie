...
public class MaterialAlertDialogBuilder extends C0092c.C0093a {
    private static final int DEF_STYLE_ATTR = C2246R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C2246R.C2250style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C2246R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C2246R.attr.colorSurface, getClass().getCanonicalName());
    ...
    private static Context createMaterialAlertDialogThemedContext(Context context) {
        ...
        return materialAlertDialogThemeOverlay == 0 ? createThemedContext : new C0159d(createThemedContext, materialAlertDialogThemeOverlay);
    }
    ...
    public C0092c create() {
        C0092c create = super.create();
        Window window = create.getWindow();
        View decorView = window.getDecorView();
        Drawable drawable = this.background;
        if (drawable instanceof MaterialShapeDrawable) {
            ((MaterialShapeDrawable) drawable).setElevation(C0656u.m2631n(decorView));
        }
