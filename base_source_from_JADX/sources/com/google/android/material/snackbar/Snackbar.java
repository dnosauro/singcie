...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C2246R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarButtonStyleAttr(findSuitableParent.getContext()) ? C2246R.layout.mtrl_layout_snackbar_include : C2246R.layout.design_layout_snackbar_include, findSuitableParent, false);
    ...
    public Snackbar setBackgroundTintList(ColorStateList colorStateList) {
        C0595a.m2319a(this.view.getBackground().mutate(), colorStateList);
        return this;
    }
