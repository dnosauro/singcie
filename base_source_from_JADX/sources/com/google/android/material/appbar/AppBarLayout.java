...
import androidx.core.p030h.C0644i;
...
public class AppBarLayout extends LinearLayout {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private View findFirstScrollingChild(CoordinatorLayout coordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if ((childAt instanceof C0644i) || (childAt instanceof ListView) || (childAt instanceof ScrollView)) {
                    return childAt;
                }
            }
            return null;
            ...
            while (true) {
                ...
                if (abs < childAt.getTop() || abs > childAt.getBottom()) {
                    ...
                    if ((scrollFlags & 1) != 0) {
                        ...
                        if ((scrollFlags & 2) != 0) {
                            i2 -= C0656u.m2629l(childAt);
                        }
                    }
                    if (C0656u.m2635r(childAt)) {
                        i2 -= t.getTopInset();
                    }
                    if (i2 > 0) {
                        float f = (float) i2;
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int i = 0; i < size; i++) {
                CoordinatorLayout.C0471b b = ((CoordinatorLayout.C0474e) dependents.get(i).getLayoutParams()).mo3374b();
                if (b instanceof ScrollingViewBehavior) {
                    return ((ScrollingViewBehavior) b).getOverlayTop() != 0;
                }
            }
            return false;
        }
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    if (checkFlag(scrollFlags, 2)) {
                        ...
                        int l = C0656u.m2629l(childAt) + i2;
                    ...
                    animateOffsetTo(coordinatorLayout, t, C0525a.m2079a(i, -t.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        private void updateAppBarLayoutDrawableState(CoordinatorLayout coordinatorLayout, T t, int i, int i2, boolean z) {
            ...
            if (appBarChildOnOffset != null) {
                ...
                boolean z2 = false;
                if ((scrollFlags & 1) != 0) {
                    int l = C0656u.m2629l(appBarChildOnOffset);
                    if (i2 <= 0 || (scrollFlags & 12) == 0 ? !((scrollFlags & 2) == 0 || (-i) < (appBarChildOnOffset.getBottom() - l) - t.getTopInset()) : (-i) >= (appBarChildOnOffset.getBottom() - l) - t.getTopInset()) {
                        z2 = true;
                    }
                }
                if (t.isLiftOnScroll()) {
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                View childAt = t.getChildAt(i2);
                setHeaderTopBottomOffset(coordinatorLayout, t, (-childAt.getBottom()) + (this.offsetToChildIndexOnLayoutIsMinHeight ? C0656u.m2629l(childAt) + t.getTopInset() : Math.round(((float) childAt.getHeight()) * this.offsetToChildIndexOnLayoutPerc)));
            ...
            setTopAndBottomOffset(C0525a.m2079a(getTopAndBottomOffset(), -t.getTotalScrollRange(), 0));
        ...
        public boolean onMeasureChild(CoordinatorLayout coordinatorLayout, T t, int i, int i2, int i3, int i4) {
            if (((CoordinatorLayout.C0474e) t.getLayoutParams()).height != -2) {
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            while (i < childCount) {
                ...
                if (childAt.getTop() + topAndBottomOffset > 0 || bottom < 0) {
                    ...
                    if (bottom == C0656u.m2629l(childAt) + t.getTopInset()) {
                        z = true;
                    }
        ...
        public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T t, int i, int i2, int i3) {
            ...
            if (i2 == 0 || topBottomOffsetForScrollingSibling < i2 || topBottomOffsetForScrollingSibling > i3) {
                ...
                int a = C0525a.m2079a(i, i2, i3);
                if (topBottomOffsetForScrollingSibling != a) {
                    int interpolateOffset = t.hasChildWithInterpolator() ? interpolateOffset(t, a) : a;
                    boolean topAndBottomOffset = setTopAndBottomOffset(interpolateOffset);
                    i4 = topBottomOffsetForScrollingSibling - a;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2246R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C2246R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(C2246R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C2246R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2246R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C2246R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }

        private static int getAppBarLayoutOffset(AppBarLayout appBarLayout) {
            CoordinatorLayout.C0471b b = ((CoordinatorLayout.C0474e) appBarLayout.getLayoutParams()).mo3374b();
            if (b instanceof BaseBehavior) {
                return ((BaseBehavior) b).getTopBottomOffsetForScrollingSibling();
            }
            return 0;
        }

        private void offsetChildAsNeeded(View view, View view2) {
            CoordinatorLayout.C0471b b = ((CoordinatorLayout.C0474e) view2.getLayoutParams()).mo3374b();
            if (b instanceof BaseBehavior) {
                C0656u.m2618e(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) b).offsetDelta) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2246R.attr.appBarLayoutStyle);
    }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, i, C2246R.C2250style.Widget_Design_AppBarLayout);
        }
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2246R.styleable.AppBarLayout, i, C2246R.C2250style.Widget_Design_AppBarLayout, new int[0]);
        C0656u.m2590a((View) this, obtainStyledAttributes.getDrawable(C2246R.styleable.AppBarLayout_android_background));
        ...
        if (obtainStyledAttributes.hasValue(C2246R.styleable.AppBarLayout_expanded)) {
            setExpanded(obtainStyledAttributes.getBoolean(C2246R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && obtainStyledAttributes.hasValue(C2246R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) obtainStyledAttributes.getDimensionPixelSize(C2246R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (obtainStyledAttributes.hasValue(C2246R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(obtainStyledAttributes.getBoolean(C2246R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (obtainStyledAttributes.hasValue(C2246R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(obtainStyledAttributes.getBoolean(C2246R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = obtainStyledAttributes.getBoolean(C2246R.styleable.AppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = obtainStyledAttributes.getResourceId(C2246R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(obtainStyledAttributes.getDrawable(C2246R.styleable.AppBarLayout_statusBarForeground));
        obtainStyledAttributes.recycle();
        C0656u.m2595a((View) this, (C0652q) new C0652q() {
            public C0633ac onApplyWindowInsets(View view, C0633ac acVar) {
                return AppBarLayout.this.onWindowInsetChanged(acVar);
            }
        });
    }
    ...
    private boolean shouldOffsetFirstChild() {
        ...
        return childAt.getVisibility() != 8 && !C0656u.m2635r(childAt);
    }

    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable materialShapeDrawable, boolean z) {
        float dimension = getResources().getDimension(C2246R.dimen.design_appbar_elevation);
        ...
        this.elevationOverlayAnimator.setDuration((long) getResources().getInteger(C2246R.integer.app_bar_elevation_anim_duration));
    ...
    public int getDownNestedPreScrollRange() {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if ((i4 & 5) == 5) {
                ...
                if ((i4 & 8) != 0) {
                    l = C0656u.m2629l(childAt);
                } else if ((i4 & 2) != 0) {
                    l = measuredHeight - C0656u.m2629l(childAt);
                } else {
                    i = i5 + measuredHeight;
                    if (childCount == 0 && C0656u.m2635r(childAt)) {
    ...
    public final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        if (l == 0) {
            int childCount = getChildCount();
            l = childCount >= 1 ? C0656u.m2629l(getChildAt(childCount - 1)) : 0;
            if (l == 0) {
                return getHeight() / 3;
            }
        }
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C2246R.attr.state_liftable : -C2246R.attr.state_liftable;
        iArr[1] = (!this.liftable || !this.lifted) ? -C2246R.attr.state_lifted : C2246R.attr.state_lifted;
        iArr[2] = this.liftable ? C2246R.attr.state_collapsible : -C2246R.attr.state_collapsible;
        iArr[3] = (!this.liftable || !this.lifted) ? -C2246R.attr.state_collapsed : C2246R.attr.state_collapsed;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (C0656u.m2635r(this) && shouldOffsetFirstChild()) {
            int topInset = getTopInset();
            for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
                C0656u.m2618e(getChildAt(childCount), topInset);
            }
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824 && C0656u.m2635r(this) && shouldOffsetFirstChild()) {
            int measuredHeight = getMeasuredHeight();
            if (mode == Integer.MIN_VALUE) {
                measuredHeight = C0525a.m2079a(getMeasuredHeight() + getTopInset(), 0, View.MeasureSpec.getSize(i2));
            } else if (mode == 0) {
    ...
    public void setExpanded(boolean z) {
        setExpanded(z, C0656u.m2642y(this));
    }
    ...
    public void setStatusBarForeground(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable4 != null) {
                ...
                C0595a.m2325b(this.statusBarForeground, C0656u.m2621g(this));
    ...
    public void setStatusBarForegroundResource(int i) {
        setStatusBarForeground(C0070a.m63b(getContext(), i));
    }
