...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
        ...
        public void run() {
            if (this.layout != null && HeaderBehavior.this.scroller != null) {
                if (HeaderBehavior.this.scroller.computeScrollOffset()) {
                    ...
                    C0656u.m2597a((View) this.layout, (Runnable) this);
                    return;
                }
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, V v, int i, int i2, float f) {
        ...
        if (this.scroller.computeScrollOffset()) {
            ...
            C0656u.m2597a((View) v, this.flingRunnable);
            return true;
        }
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case 1:
                ...
                if (velocityTracker2 != null) {
                    ...
                    this.velocityTracker.computeCurrentVelocity(ParseQuery.MAX_LIMIT);
    ...
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int i, int i2, int i3) {
        ...
        if (i2 == 0 || topAndBottomOffset < i2 || topAndBottomOffset > i3 || topAndBottomOffset == (a = C0525a.m2079a(i, i2, i3))) {
            return 0;
        }
