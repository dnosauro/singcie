...
public final class MaterialDatePicker<S> extends C0733c {
    ...
    public static final class Builder<S> {
        ...
        public static Builder<C0583d<Long, Long>> dateRangePicker() {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, C0070a.m63b(context, C2246R.C2248drawable.ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], C0070a.m63b(context, C2246R.C2248drawable.ic_edit_black_24dp));
        return stateListDrawable;
    }

    private static int getDialogPickerHeight(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelSize = resources.getDimensionPixelSize(C2246R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C2246R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C2246R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C2246R.dimen.mtrl_calendar_days_of_week_height);
        return dimensionPixelSize + dimensionPixelSize2 + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C2246R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C2246R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C2246R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C2246R.dimen.mtrl_calendar_content_padding);
        int i = Month.today().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C2246R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C2246R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    private void initHeaderToggle(Context context) {
        ...
        C0656u.m2594a((View) this.headerToggleButton, (C0610a) null);
    ...
    static boolean isFullscreen(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C2246R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{16843277});
    ...
    public void startPickerFragment() {
        ...
        updateHeader();
        C0775p a = getChildFragmentManager().mo4359a();
        a.mo4522a(C2246R.C2249id.mtrl_calendar_frame, (C0735d) this.pickerFragment);
        a.mo4075d();
        this.pickerFragment.addOnSelectionChangedListener(new OnSelectionChangedListener<S>() {
            public void onSelectionChanged(S s) {
                ...
                if (MaterialDatePicker.this.dateSelector.isSelectionComplete()) {
                    button = MaterialDatePicker.this.confirmButton;
                    z = true;
                } else {
                    button = MaterialDatePicker.this.confirmButton;
                    z = false;
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C2246R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            ...
            i = C2246R.string.mtrl_picker_toggle_to_calendar_input_mode;
        } else {
            context = checkableImageButton.getContext();
            i = C2246R.string.mtrl_picker_toggle_to_text_input_mode;
        }
        this.headerToggleButton.setContentDescription(context.getString(i));
    }
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C2246R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        this.background = new MaterialShapeDrawable(context, (AttributeSet) null, C2246R.attr.materialCalendarStyle, C2246R.C2250style.Widget_MaterialComponents_MaterialCalendar);
        this.background.initializeElevationOverlay(context);
        this.background.setFillColor(ColorStateList.valueOf(resolveOrThrow));
        this.background.setElevation(C0656u.m2631n(dialog.getWindow().getDecorView()));
        return dialog;
    }

    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C2246R.layout.mtrl_picker_fullscreen : C2246R.layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C2246R.C2249id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C2246R.C2249id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C2246R.C2249id.mtrl_calendar_frame);
        ...
        this.headerSelectionText = (TextView) inflate.findViewById(C2246R.C2249id.mtrl_picker_header_selection_text);
        C0656u.m2614d(this.headerSelectionText, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C2246R.C2249id.mtrl_picker_header_toggle);
        TextView textView = (TextView) inflate.findViewById(C2246R.C2249id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C2246R.C2249id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C2246R.C2249id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C2246R.dimen.mtrl_calendar_dialog_background_inset);
