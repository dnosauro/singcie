...
class YearGridAdapter extends RecyclerView.C1011a<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        String string = viewHolder.textView.getContext().getString(C2246R.string.mtrl_picker_navigate_to_year_description);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder((TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C2246R.layout.mtrl_calendar_year, viewGroup, false));
    }
}
