...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2246R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2246R.styleable.MaterialButtonToggleGroup, i, C2246R.C2250style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
        setSingleSelection(obtainStyledAttributes.getBoolean(C2246R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = obtainStyledAttributes.getResourceId(C2246R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        if (firstVisibleChildIndex != -1) {
            for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
                ...
                if (getOrientation() == 0) {
                    C0641f.m2532b(buildLayoutParams, 0);
                    C0641f.m2530a(buildLayoutParams, -min);
                } else {
    ...
    private void resetChildMargins(int i) {
        if (getChildCount() != 0 && i != -1) {
            ...
            C0641f.m2532b(layoutParams, 0);
            C0641f.m2530a(layoutParams, 0);
    ...
    private void setGeneratedIdIfNeeded(MaterialButton materialButton) {
        if (materialButton.getId() == -1) {
            materialButton.setId(C0656u.m2579a());
        }
    }
