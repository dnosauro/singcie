...
class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, (float) rect2.top, 0.0f, (float) rect2.bottom, new int[]{C0589a.m2270a(this.topOuterStrokeColor, this.currentBorderTintColor), C0589a.m2270a(this.topInnerStrokeColor, this.currentBorderTintColor), C0589a.m2270a(C0589a.m2272b(this.topInnerStrokeColor, 0), this.currentBorderTintColor), C0589a.m2270a(C0589a.m2272b(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), C0589a.m2270a(this.bottomInnerStrokeColor, this.currentBorderTintColor), C0589a.m2270a(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
