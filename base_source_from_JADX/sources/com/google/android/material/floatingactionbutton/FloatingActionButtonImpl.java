...
class FloatingActionButtonImpl {
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C2246R.animator.design_fab_hide_motion_spec);
        }
        return (MotionSpec) C0588f.m2266a(this.defaultHideMotionSpec);
    }

    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C2246R.animator.design_fab_show_motion_spec);
        }
        return (MotionSpec) C0588f.m2266a(this.defaultShowMotionSpec);
    }
    ...
    private boolean shouldAnimateVisibilityChange() {
        return C0656u.m2642y(this.view) && !this.view.isInEditMode();
    }
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new MaterialShapeDrawable((ShapeAppearanceModel) C0588f.m2266a(this.shapeAppearance));
    }
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        this.contentBackground = new LayerDrawable(new Drawable[]{(Drawable) C0588f.m2266a(this.shapeDrawable), rippleDrawableCompat});
    }
    ...
    public void onPaddingUpdated(android.graphics.Rect r8) {
        /*
            ...
            androidx.core.p029g.C0588f.m2267a(r0, (java.lang.Object) r1)
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        ...
        if (drawable != null) {
            C0595a.m2319a(drawable, RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        }
    }
