...
final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C2246R.dimen.design_textinput_caption_translate_y));
    ...
    private boolean shouldAnimateCaptionView(TextView textView, CharSequence charSequence) {
        return C0656u.m2642y(this.textInputView) && this.textInputView.isEnabled() && (this.captionToShow != this.captionDisplayed || textView == null || !TextUtils.equals(textView.getText(), charSequence));
    }
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            C0656u.m2586a(this.indicatorArea, C0656u.m2625i(this.textInputView.getEditText()), 0, C0656u.m2627j(this.textInputView.getEditText()), 0);
        }
    }
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            cancelCaptionAnimator();
            if (z) {
                this.errorView = new C0252aa(this.context);
                this.errorView.setId(C2246R.C2249id.textinput_error);
                ...
                C0656u.m2614d(this.errorView, 1);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            cancelCaptionAnimator();
            if (z) {
                this.helperTextView = new C0252aa(this.context);
                this.helperTextView.setId(C2246R.C2249id.textinput_helper_text);
                Typeface typeface2 = this.typeface;
                if (typeface2 != null) {
                    this.helperTextView.setTypeface(typeface2);
                }
                this.helperTextView.setVisibility(4);
                C0656u.m2614d(this.helperTextView, 1);
