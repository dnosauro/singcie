...
public class MaterialShapeDrawable extends Drawable implements C0596b, Shapeable {
    ...
    private void calculateStrokePath() {
        ...
        this.strokeShapeAppearance = getShapeAppearanceModel().withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator() {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f) {
        int color = MaterialColors.getColor(context, C2246R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
    ...
    private boolean updateTintFilter() {
        ...
        return !C0582c.m2256a(porterDuffColorFilter, this.tintFilter) || !C0582c.m2256a(porterDuffColorFilter2, this.strokeTintFilter);
    }
