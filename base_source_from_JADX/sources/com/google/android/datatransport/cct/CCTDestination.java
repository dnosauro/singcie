...
public final class CCTDestination implements EncodedDestination {
    public static final CCTDestination INSTANCE = new CCTDestination(zza, (String) null);
    ...
    private static final Set<Encoding> zzd = Collections.unmodifiableSet(new HashSet(Arrays.asList(new Encoding[]{Encoding.m8671of("proto"), Encoding.m8671of("json")})));
