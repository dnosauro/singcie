...
import com.google.android.datatransport.cct.p149a.zzn;
...
public abstract class zzt {
    ...
    public enum zzb {
        ...
        static {
            ...
            zzb[] zzbArr = {UNKNOWN_MOBILE_SUBTYPE, GPRS, EDGE, UMTS, CDMA, EVDO_0, EVDO_A, RTT, HSDPA, HSUPA, HSPA, IDEN, EVDO_B, LTE, EHRPD, HSPAP, GSM, TD_SCDMA, IWLAN, LTE_CA, COMBINED};
            zzv = new SparseArray<>();
            zzv.put(0, UNKNOWN_MOBILE_SUBTYPE);
            zzv.put(1, GPRS);
            zzv.put(2, EDGE);
            zzv.put(3, UMTS);
            zzv.put(4, CDMA);
    ...
    public enum zzc {
        ...
        static {
            ...
            zzc[] zzcArr = {MOBILE, WIFI, MOBILE_MMS, MOBILE_SUPL, MOBILE_DUN, MOBILE_HIPRI, WIMAX, BLUETOOTH, DUMMY, ETHERNET, MOBILE_FOTA, MOBILE_IMS, MOBILE_CBS, WIFI_P2P, MOBILE_IA, MOBILE_EMERGENCY, PROXY, VPN, NONE};
            zzt = new SparseArray<>();
            zzt.put(0, MOBILE);
            zzt.put(1, WIFI);
