...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    private static final List<Migration> INCREMENTAL_MIGRATIONS = Arrays.asList(new Migration[]{MIGRATE_TO_V1, MIGRATE_TO_V2, MIGRATE_TO_V3, MIGRATE_TO_V4});
    ...
    private static final Migration MIGRATE_TO_V4 = SchemaManager$$Lambda$4.lambdaFactory$();
