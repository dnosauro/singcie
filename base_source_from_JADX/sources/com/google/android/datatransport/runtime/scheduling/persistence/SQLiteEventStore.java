...
public class SQLiteEventStore implements EventStore, SynchronizationGuard {
    ...
    private static final Encoding PROTOBUF_ENCODING = Encoding.m8671of("proto");
    ...
    static /* synthetic */ Object lambda$loadEvents$12(SQLiteEventStore sQLiteEventStore, List list, TransportContext transportContext, Cursor cursor) {
        while (cursor.moveToNext()) {
            ...
            uptimeMillis.setEncodedPayload(z ? new EncodedPayload(toEncoding(cursor.getString(4)), cursor.getBlob(5)) : new EncodedPayload(toEncoding(cursor.getString(4)), sQLiteEventStore.readPayload(j)));
            if (!cursor.isNull(6)) {
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(')');
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{"event_id", AppMeasurementSdk.ConditionalUserProperty.NAME, "value"}, sb.toString(), (String[]) null, (String) null, (String) null, (String) null), SQLiteEventStore$$Lambda$17.lambdaFactory$(hashMap));
        return hashMap;
    }
    ...
    private static Encoding toEncoding(String str) {
        return str == null ? PROTOBUF_ENCODING : Encoding.m8671of(str);
    }
    ...
    public PersistedEvent persist(TransportContext transportContext, EventInternal eventInternal) {
        Logging.m8676d(LOG_TAG, "Storing event with priority=%s, name=%s for destination %s", transportContext.getPriority(), eventInternal.getTransportName(), transportContext.getBackendName());
