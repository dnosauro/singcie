...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    static void zaa(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        if (activity instanceof C0744e) {
            SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((C0744e) activity).getSupportFragmentManager(), str);
            return;
        }
    ...
    private final void zaa(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            C0510i.C0515e a = new C0510i.C0515e(context).mo3476c(true).mo3473b(true).mo3465a((CharSequence) errorNotificationTitle).mo3464a((C0510i.C0516f) new C0510i.C0513c().mo3448a((CharSequence) errorNotificationMessage));
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                a.mo3457a(context.getApplicationInfo().icon).mo3477d(2);
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    a.mo3459a(C2231R.C2233drawable.common_full_open_on_phone, (CharSequence) resources.getString(C2231R.string.common_open_on_phone), pendingIntent);
                } else {
                    a.mo3461a(pendingIntent);
                }
            } else {
                a.mo3457a(17301642).mo3475c((CharSequence) resources.getString(C2231R.string.common_google_play_services_notification_ticker)).mo3460a(System.currentTimeMillis()).mo3461a(pendingIntent).mo3472b((CharSequence) errorNotificationMessage);
            }
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (zag == null) {
                    ...
                    if (notificationChannel == null) {
                        notificationChannel = new NotificationChannel(zag, defaultNotificationChannelName, 4);
