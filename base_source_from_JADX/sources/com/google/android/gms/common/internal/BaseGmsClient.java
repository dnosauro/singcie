        ...
        synchronized (this.zzp) {
            ...
            switch (i) {
                ...
                case 3:
                    ...
                    this.zzk = (this.zzv != 3 || getLocalStartServiceAction() == null) ? new zzk(getStartServicePackage(), getStartServiceAction(), false, GmsClientSupervisor.getDefaultBindFlags(), getUseDynamicLookup()) : new zzk(getContext().getPackageName(), getLocalStartServiceAction(), true, GmsClientSupervisor.getDefaultBindFlags(), false);
