...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.Field(getter = "getColumns", mo11699id = 1)
    private final String[] zalq;
    private Bundle zalr;
    @SafeParcelable.Field(getter = "getWindows", mo11699id = 2)
    private final CursorWindow[] zals;
    @SafeParcelable.Field(getter = "getStatusCode", mo11699id = 3)
    private final int zalt;
    @SafeParcelable.Field(getter = "getMetadata", mo11699id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo11702id = 1000) int i, @SafeParcelable.Param(mo11702id = 1) String[] strArr, @SafeParcelable.Param(mo11702id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo11702id = 3) int i2, @SafeParcelable.Param(mo11702id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
    ...
    private static CursorWindow[] zaa(Builder builder, int i) {
        ...
        List zab = (i < 0 || i >= builder.zalz.size()) ? builder.zalz : builder.zalz.subList(0, i);
        int size = zab.size();
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, ParseQuery.MAX_LIMIT, this.zalf);
