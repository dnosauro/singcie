...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo11699id = 2)
    private final int zzb;
    @SafeParcelable.Field(getter = "getResolution", mo11699id = 3)
    private final PendingIntent zzc;
    @SafeParcelable.Field(getter = "getErrorMessage", mo11699id = 4)
    ...
    ConnectionResult(@SafeParcelable.Param(mo11702id = 1) int i, @SafeParcelable.Param(mo11702id = 2) int i2, @SafeParcelable.Param(mo11702id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo11702id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
