...
final class zzc {
    ...
    static final /* synthetic */ String zza(boolean z, String str, zzd zzd) {
        boolean z2 = true;
    ...
    private static zzl zzb(String str, zzd zzd, boolean z, boolean z2) {
        try {
            ...
            Preconditions.checkNotNull(zzc);
            try {
                return zza.zza(new zzj(str, zzd, z, z2), ObjectWrapper.wrap(zzc.getPackageManager())) ? zzl.zza() : zzl.zza((Callable<String>) new zze(z, str, zzd));
