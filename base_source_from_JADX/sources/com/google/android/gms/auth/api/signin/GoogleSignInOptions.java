...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo11699id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo11699id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo11699id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo11699id = 9)
    ...
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getScopes", mo11699id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo11699id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo11699id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo11699id = 5)
    ...
    public static final class Builder {
        ...
        public final GoogleSignInOptions build() {
            ...
            return new GoogleSignInOptions(3, new ArrayList(this.mScopes), this.zax, this.zay, this.zaz, this.zaaa, this.zaab, this.zaac, this.zaag, (zac) null);
        }
    ...
    GoogleSignInOptions(@SafeParcelable.Param(mo11702id = 1) int i, @SafeParcelable.Param(mo11702id = 2) ArrayList<Scope> arrayList, @SafeParcelable.Param(mo11702id = 3) Account account, @SafeParcelable.Param(mo11702id = 4) boolean z, @SafeParcelable.Param(mo11702id = 5) boolean z2, @SafeParcelable.Param(mo11702id = 6) boolean z3, @SafeParcelable.Param(mo11702id = 7) String str, @SafeParcelable.Param(mo11702id = 8) String str2, @SafeParcelable.Param(mo11702id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
