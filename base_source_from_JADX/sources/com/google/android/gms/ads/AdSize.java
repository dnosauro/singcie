...
public final class AdSize {
    ...
    public static final AdSize MEDIUM_RECTANGLE = new AdSize(300, ParseException.LINKED_ID_MISSING, "300x250_as");
    ...
    public static AdSize getCurrentOrientationAnchoredAdaptiveBannerAdSize(Context context, int i) {
        AdSize zza = zzayr.zza(context, i, 50, 0);
        zza.zzacw = true;
        return zza;
    }
    ...
    public static AdSize getLandscapeAnchoredAdaptiveBannerAdSize(Context context, int i) {
        AdSize zza = zzayr.zza(context, i, 50, 2);
        zza.zzacw = true;
        return zza;
    }
    ...
    public static AdSize getPortraitAnchoredAdaptiveBannerAdSize(Context context, int i) {
        AdSize zza = zzayr.zza(context, i, 50, 1);
        zza.zzacw = true;
        return zza;
    }
    ...
    public final int getHeightInPixels(Context context) {
        switch (this.height) {
            ...
            default:
                zzwq.zzqa();
                return zzayr.zzc(context, this.height);
        }
    }
    ...
    public final int getWidthInPixels(Context context) {
        ...
        switch (i) {
            ...
            default:
                zzwq.zzqa();
                return zzayr.zzc(context, this.width);
        }
    }
