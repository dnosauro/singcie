...
final class zzho<T extends zzhq<T>> {
    ...
    static void zza(zzhf zzhf, zzle zzle, int i, Object obj) {
        if (zzle == zzle.GROUP) {
            zzjg zzjg = (zzjg) obj;
            zzhx.zza(zzjg);
            zzhf.zza(i, 3);
    ...
    private static int zzb(zzle zzle, Object obj) {
        switch (zzhn.zzb[zzle.ordinal()]) {
            ...
            case 10:
                return obj instanceof zzih ? zzhf.zza((zzil) (zzih) obj) : zzhf.zzb((zzjg) obj);
            case 11:
                return obj instanceof zzgm ? zzhf.zzb((zzgm) obj) : zzhf.zzb((String) obj);
            case 12:
                return obj instanceof zzgm ? zzhf.zzb((zzgm) obj) : zzhf.zzb((byte[]) obj);
            case 13:
            ...
            case 18:
                return obj instanceof zzia ? zzhf.zzk(((zzia) obj).zza()) : zzhf.zzk(((Integer) obj).intValue());
            default:
    ...
    private final void zzb(Map.Entry<T, Object> entry) {
        ...
        if (zzhq.zzd()) {
            ...
            if (zza4 == null) {
                ...
                this.zza.put(zzhq, zza4 instanceof zzjl ? zzhq.zza((zzjl) zza4, (zzjl) value) : zzhq.zza(((zzjg) zza4).zzbt(), (zzjg) value).zzy());
            }
        } else {
            this.zza.put(zzhq, zza(value));
        }
    ...
    private static int zzc(Map.Entry<T, Object> entry) {
        zzhq zzhq = (zzhq) entry.getKey();
        Object value = entry.getValue();
        return (zzhq.zzc() != zzlh.MESSAGE || zzhq.zzd() || zzhq.zze()) ? zza((zzhq<?>) zzhq, value) : value instanceof zzih ? zzhf.zzb(((zzhq) entry.getKey()).zza(), (zzil) (zzih) value) : zzhf.zzb(((zzhq) entry.getKey()).zza(), (zzjg) value);
    }
