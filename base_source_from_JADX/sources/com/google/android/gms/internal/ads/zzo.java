...
final class zzo implements zzac {
    ...
    public final synchronized boolean zzb(com.google.android.gms.internal.ads.zzaa<?> r6) {
        ...
        L_0x001e:
            ...
            com.google.android.gms.internal.ads.zzaq.m8702d(r6, r1)     // Catch:{ all -> 0x0052 }
        L_0x0038:
            monitor-exit(r5)
            return r2
        L_0x003a:
    ...
    public final synchronized void zza(zzaa<?> zzaa) {
        ...
        if (remove != null && !remove.isEmpty()) {
            if (zzaq.DEBUG) {
                zzaq.m8704v("%d waiting requests for cacheKey=%s; resend to network", Integer.valueOf(remove.size()), zze);
            }
            ...
            try {
                ...
                zzaq.m8703e("Couldn't add request to queue. %s", e.toString());
    ...
    public final void zza(zzaa<?> zzaa, zzaj<?> zzaj) {
        List<zzaa> remove;
        if (zzaj.zzbq == null || zzaj.zzbq.zza()) {
            zza(zzaa);
            return;
        }
        String zze = zzaa.zze();
        ...
        if (remove != null) {
            if (zzaq.DEBUG) {
                zzaq.m8704v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(remove.size()), zze);
            }
            for (zzaa zzb : remove) {
