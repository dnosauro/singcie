...
public final class zzpt {
    ...
    public static ExecutorService zzbf(String str) {
        return Executors.newSingleThreadExecutor(new zzps(str));
    }
