...
public final class zzaey extends NativeAppInstallAd {
    ...
    public zzaey(com.google.android.gms.internal.ads.zzaex r5) {
        /*
            r4 = this;
            r4.<init>()
            ...
            r4.zzdeu = r5
            r5 = 0
            com.google.android.gms.internal.ads.zzaex r0 = r4.zzdeu     // Catch:{ RemoteException -> 0x0055 }
        ...
        L_0x005b:
            com.google.android.gms.internal.ads.zzaex r0 = r4.zzdeu     // Catch:{ RemoteException -> 0x0069 }
            com.google.android.gms.internal.ads.zzaej r0 = r0.zzsw()     // Catch:{ RemoteException -> 0x0069 }
        ...
        L_0x0070:
            r4.zzdew = r1
            com.google.android.gms.internal.ads.zzaex r0 = r4.zzdeu     // Catch:{ RemoteException -> 0x0087 }
            ...
            com.google.android.gms.internal.ads.zzaex r1 = r4.zzdeu     // Catch:{ RemoteException -> 0x0087 }
        ...
        L_0x008d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaey.<init>(com.google.android.gms.internal.ads.zzaex):void");
    }
    ...
    public final CharSequence getCallToAction() {
        try {
            return this.zzdeu.getCallToAction();
        } catch (RemoteException e) {
            zzaza.zzc("", e);
            return null;
        }
    ...
    public final CharSequence getMediationAdapterClassName() {
        try {
            return this.zzdeu.getMediationAdapterClassName();
        } catch (RemoteException e) {
            zzaza.zzc("", e);
            return null;
        }
    ...
    public final Double getStarRating() {
        try {
            double starRating = this.zzdeu.getStarRating();
            if (starRating == -1.0d) {
                return null;
            }
    ...
    public final VideoController getVideoController() {
        try {
            if (this.zzdeu.getVideoController() != null) {
                this.zzcjv.zza(this.zzdeu.getVideoController());
            }
        } catch (RemoteException e) {
    ...
    public final void performClick(Bundle bundle) {
        try {
            this.zzdeu.performClick(bundle);
        } catch (RemoteException e) {
            zzaza.zzc("", e);
        }
    }
    ...
    public final boolean recordImpression(Bundle bundle) {
        try {
            return this.zzdeu.recordImpression(bundle);
        } catch (RemoteException e) {
            zzaza.zzc("", e);
            return false;
        }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        try {
            this.zzdeu.reportTouchEvent(bundle);
        } catch (RemoteException e) {
            zzaza.zzc("", e);
        }
    }
