...
public final class ASN1Set extends ASN1Element {
    ...
    public ASN1Set(byte b, Collection<? extends ASN1Element> collection) {
        super(b);
    ...
    private ASN1Set(byte b, ASN1Element[] aSN1ElementArr, byte[] bArr) {
        super(b);
        this.elements = aSN1ElementArr;
    ...
    public static ASN1Set decodeAsSet(ASN1Element aSN1Element) {
        ...
        while (i2 < value.length) {
            try {
                ...
                throw new ASN1Exception(ASN1Messages.ERR_SET_DECODE_EXCEPTION.get(String.valueOf(aSN1Element), e2), e2);
            }
        }
    ...
    public static ASN1Set decodeAsSet(byte[] bArr) {
        int i;
        try {
            ...
            Debug.debugException(e2);
            throw new ASN1Exception(ASN1Messages.ERR_SET_BYTES_DECODE_EXCEPTION.get(e2), e2);
