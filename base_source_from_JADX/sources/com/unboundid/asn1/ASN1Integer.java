...
public final class ASN1Integer extends ASN1Element {
    ...
    public static com.unboundid.asn1.ASN1Integer decodeAsInteger(com.unboundid.asn1.ASN1Element r5) {
        /*
            byte[] r0 = r5.getValue()
            int r1 = r0.length
            r2 = 2
        ...
        L_0x000b:
            ...
            com.unboundid.asn1.ASN1Messages r1 = com.unboundid.asn1.ASN1Messages.ERR_INTEGER_INVALID_LENGTH
        ...
        L_0x0076:
            com.unboundid.asn1.ASN1Integer r2 = new com.unboundid.asn1.ASN1Integer
            byte r5 = r5.getType()
            r2.<init>(r5, r1, r0)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unboundid.asn1.ASN1Integer.decodeAsInteger(com.unboundid.asn1.ASN1Element):com.unboundid.asn1.ASN1Integer");
    }

    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.unboundid.asn1.ASN1Integer decodeAsInteger(byte[] r8) {
        /*
            r0 = 1
            r1 = 0
        ...
        L_0x0086:
            com.unboundid.asn1.ASN1Integer r4 = new com.unboundid.asn1.ASN1Integer     // Catch:{ ASN1Exception -> 0x00d1, Exception -> 0x00bd }
        ...
        L_0x00d1:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unboundid.asn1.ASN1Integer.decodeAsInteger(byte[]):com.unboundid.asn1.ASN1Integer");
    }

    static byte[] encodeIntValue(int i) {
        if (i >= 0) {
            int i2 = i & CertificateBody.profileType;
            if (i2 == i) {
                return new byte[]{(byte) i2};
            } else if ((i & 32767) == i) {
                return new byte[]{(byte) ((i >> 8) & CertificateBody.profileType), (byte) (i & 255)};
            } else if ((8388607 & i) == i) {
                return new byte[]{(byte) ((i >> 16) & CertificateBody.profileType), (byte) ((i >> 8) & 255), (byte) (i & 255)};
            } else {
                return new byte[]{(byte) ((i >> 24) & CertificateBody.profileType), (byte) ((i >> 16) & 255), (byte) ((i >> 8) & 255), (byte) (i & 255)};
            }
        } else if ((i & -128) == -128) {
