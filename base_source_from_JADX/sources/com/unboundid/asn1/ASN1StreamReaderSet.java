...
public final class ASN1StreamReaderSet {
    ...
    ASN1StreamReaderSet(ASN1StreamReader aSN1StreamReader, byte b, int i) {
    ...
    public boolean hasMoreElements() {
        ...
        throw new ASN1Exception(ASN1Messages.ERR_STREAM_READER_SET_READ_PAST_END.get(Integer.valueOf(this.length), Long.valueOf(this.endBytesRead), Long.valueOf(totalBytesRead)));
    }
}
