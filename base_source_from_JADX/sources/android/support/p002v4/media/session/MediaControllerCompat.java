...
public final class MediaControllerCompat {
    ...
    private static class MediaControllerExtraData extends C0506f.C0507a {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(C0504e.m1972a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        ...
        if (activity instanceof C0506f) {
            MediaControllerExtraData mediaControllerExtraData = (MediaControllerExtraData) ((C0506f) activity).getExtraData(MediaControllerExtraData.class);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        if (activity instanceof C0506f) {
            ((C0506f) activity).putExtraData(new MediaControllerExtraData(mediaControllerCompat));
        }
        if (Build.VERSION.SDK_INT >= 21) {
            Object obj = null;
