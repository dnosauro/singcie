...
public class AlertDialogLayout extends C0266aj {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: a */
    private static int m762a(View view) {
        int l = C0656u.m2629l(view);
        if (l > 0) {
            return l;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m762a(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: a */
    private void m763a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: a */
    private boolean m764a(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0059a.C0065f.topPanel) {
                    view = childAt;
                } else if (id == C0059a.C0065f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0059a.C0065f.contentPanel && id != C0059a.C0065f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    /* renamed from: b */
    private void m765b(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0266aj.C0267a aVar = (C0266aj.C0267a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.aj$a r15 = (androidx.appcompat.widget.C0266aj.C0267a) r15
            int r2 = r15.f965h
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = androidx.core.p030h.C0656u.m2621g(r17)
            int r2 = androidx.core.p030h.C0637c.m2519a(r2, r3)
            r2 = r2 & 7
            r3 = 1
