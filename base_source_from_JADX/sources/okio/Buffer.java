...
public final class Buffer implements Cloneable, ByteChannel, BufferedSink, BufferedSource {
    private static final byte[] DIGITS = {ASN1Constants.UNIVERSAL_SEQUENCE_TYPE, ASN1Constants.UNIVERSAL_SET_TYPE, 50, 51, 52, 53, 54, 55, 56, 57, LDAPMessage.PROTOCOL_OP_TYPE_BIND_RESPONSE, 98, LDAPMessage.PROTOCOL_OP_TYPE_SEARCH_REQUEST, LDAPMessage.PROTOCOL_OP_TYPE_SEARCH_RESULT_ENTRY, LDAPMessage.PROTOCOL_OP_TYPE_SEARCH_RESULT_DONE, LDAPMessage.PROTOCOL_OP_TYPE_MODIFY_REQUEST};
        ...
        public final long expandBuffer(int i) {
            if (i <= 0) {
                ...
                if (buffer2 == null) {
                    ...
                    writableSegment.limit = PKIFailureInfo.certRevoked;
                    long j2 = (long) i2;
                    ...
                    this.start = 8192 - i2;
                    this.end = PKIFailureInfo.certRevoked;
                    return j2;
                } else {
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m9117of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m9117of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
    ...
    public int readUtf8CodePoint() {
        ...
        if (this.size != 0) {
            ...
            if (this.size >= j) {
                ...
                skip(j);
                return b2 > 1114111 ? REPLACEMENT_CHARACTER : ((b2 < 55296 || b2 > 57343) && b2 >= b) ? b2 : REPLACEMENT_CHARACTER;
            }
        ...
        if (str == null) {
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    int i6 = (i4 + i5) - writableSegment.limit;
                    ...
                    if (charAt < 2048) {
                        ...
                        if (charAt > 56319 || charAt3 < 56320 || charAt3 > 57343) {
                            ...
                            int i8 = (((charAt & 10239) << 10) | (9215 & charAt3)) + PKIFailureInfo.notAuthorized;
                            writeByte((i8 >> 18) | 240);
